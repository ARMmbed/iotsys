...
public class SegmentACK extends AckAPDU {
	...
	/**
	 * This parameter shall be TRUE if the Segment-ACK PDU is being sent to
	 * indicate a segment received out of order. Otherwise, it shall be FALSE.
	 */
	private final boolean negativeAck;

	/**
	 * This parameter shall be TRUE when the SegmentACK PDU is sent by a server,
	 * that is, when the SegmentACK PDU is in acknowledgment of a segment or
	 * segments of a Confirmed-Request PDU.
	 * 
	 * This parameter shall be FALSE when the SegmentACK PDU is sent by a
	 * client, that is, when the SegmentACK PDU is in acknowledgment of a
	 * segment or segments of a ComplexACK PDU.
	 */
	private final boolean server;

	/**
	 * This parameter shall contain the 'sequence-number' of a previously
	 * received message segment. It is used to acknowledge the receipt of that
	 * message segment and all earlier segments of the message.
	 * 
	 * If the 'more-follows' parameter of the received message segment is TRUE,
	 * then the 'sequence-number' also requests continuation of the segmented
	 * message beginning with the segment whose 'sequence-number' is one plus
	 * the value of this parameter, modulo 256.
	 */
	private final int sequenceNumber;

	/**
	 * This parameter shall specify as an unsigned binary integer the number of
	 * message segments containing 'original-invokeID' the sender will accept
	 * before sending another SegmentACK. See 5.3 for additional details. The
