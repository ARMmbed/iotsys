...
/**
 * Class to handle various events that occur on the local device. This class
 * accepts 0 to many listeners, and uses a executor queue to dispatch
...
public class DeviceEventHandler {
	...
	/**
	 * Creates an event multicaster and gives it to the execution service for
