...
public interface DeviceEventListener {
	...
	/**
	 * Allow a listener to veto an attempt by another device to write a property
	 * in a local object.
	 * 
	 * @param obj
	 * @param pv
	...
	/**
	 * Notification that a property of a local object was written by another
	 * device.
	 * 
	 * @param obj
	 * @param pv
	...
	/**
	 * Notification of either an UnconfirmedCovNotificationRequest or a
	 * ConfirmedCovNotificationRequest. The latter will be automatically
	 * confirmed by the service handler.
	 * 
	...
	/**
	 * Notification of either an UnconfirmedEventNotificationRequest or a
	 * ConfirmedEventNotificationRequest. The latter will be automatically
	 * confirmed by the service handler.
	 * 
	...
	/**
	 * Notification of either an UnconfirmedTextMessageRequest or a
	 * ConfirmedTextMessageRequest. The latter will be automatically confirmed
	 ...
	 * @param message
	 */
	void textMessageReceived(RemoteDevice textMessageSourceDevice, Choice messageClass, MessagePriority messagePriority,
			CharacterString message);

	/**
	 * Notification of either an UnconfirmedPrivateTransferRequest or a
	 * ConfirmedPrivateTransferRequest. The latter will be automatically
	 * confirmed by the service handler.
	 * 
	 * @param vendorId
	 * @param serviceNumber
	...
	/**
	 * Notification that the device should be reinitialized. The local device's
	 * password has already been validated at this point, the the indicated
	...
	/**
	 * Notification that the device should synchronize its time to the given
	 * date/time value. The local device has already been checked at this point
	 * to ensure that it supports time synchronization.
	 * 
	 * @param dateTime
	 * @param utc
	 *            true if a UTCTimeSynchronizationRequest was sent, false if
