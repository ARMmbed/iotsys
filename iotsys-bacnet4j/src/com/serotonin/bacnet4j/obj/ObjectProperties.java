...
public class ObjectProperties {
	...
	private static void add(ObjectType type, PropertyIdentifier pid, Class<? extends Encodable> clazz, boolean sequence,
			boolean required, Encodable defaultValue) {
