...
public class DecodingTest {
	public static void main(String[] args) throws Exception {
		...
		// String input =
		// "[81,4,0,23,c0,a8,1,5a,ba,c0,1,8,27,28,6,0,40,ae,0,73,8f,10,0,c4,2,0,9,60,22,1,e0,91,0,21,8]";
		// String input =
		// "[81,4,0,1e,c0,a8,1,5a,ba,c0,1,8,4e,38,1,3,10,0,c4,2,0,9,63,22,1,e0,91,0,21,8]";
		// String input =
		// "[81,4,0,1e,c0,a8,1,5a,ba,c0,1,8,4e,36,1,1,10,0,c4,2,0,8,99,22,1,e0,91,0,21,8]";
		// String input =
		// "[81,4,0,1e,c0,a8,1,5a,ba,c0,1,8,4e,38,1,4,10,0,c4,2,0,9,64,22,1,e0,91,0,21,8]";
		// String input =
		// "[81,4,0,1e,c0,a8,1,5a,ba,c0,1,8,4e,36,1,2,10,0,c4,2,0,8,9a,22,1,e0,91,0,21,8]";
		// String input =
		// "[81,b,0,1b,1,28,ff,ff,0,27,28,6,0,40,ae,0,73,8f,fe,10,8,a,9,62,1a,9,62]";
		// String input =
		// "[81,b,0,1b,1,28,ff,ff,0,27,28,6,0,40,ae,0,73,8f,fe,10,8,a,9,61,1a,9,61]";
		...
		// String input = "81|0a|00|17|01|20|ff|ff |00|ff|10|07|3d|09|00|65|69
		// |62|74|65|6d|70|31";
		// String input = "81 |0a|00|1d|01|00|10|01|c4|02|00|04
		// |40|c4|00|00|00|02|75|09|00|65|69 |62|74|65|6d|70|31";
		// String input = "81|0a|00|1d|01|20|ff|ff
		// |00|ff|10|07|0a|04|40|1a|04|40 |3d|09|00|65|69|62|74|65|6d |70|31";

		// WhoIs sent by Delta equipment.
		// String input = "81 0b 00 1b 01 28 ff ff 00 27 d8 06 00 18 71 73 0d 8a
		// fe 10 08 0a 11 5e 1a c3 4f";

		// IAm response
		// String input = "81 0b 00 1b 01 28 ff ff 00 c4 80 01 04 fc 10 00 c4 02
		// 00 76 c4 21 80 91 03 21 08";
		// String input =
		// "[81,b,0,18,1,20,ff,ff,0,ff,10,0,c4,2,1,2c,c8,22,5,c0,91,3,21,4d]";
		// String input =
		// "81,a,0,17,1,4,2,75,1,e,c,2,1,2c,c8,1e,9,4d,9,62,9,8b,1f";

		// Delta private message.
		// String s = "81 0b 00 4b 01 a8 ff ff 00 28 3c 06 00 40 ae 00 20 28 ff
		// 81 00 08 30 75 00 00 07 00 ff ff 04 00 23 00 31 00 00 00 00 00 00 00
		// 00 00 00 00 40 ae 00 00 02 04 00 91 01 93 01 46 00 00 00 00 00 0c 00
		// 01 00 06 00 20 29 01 00 00 00";
		// String s = "81 0b 00 4b 01 a8 ff ff 00 28 3c 06 00 40 ae 00 20 28 ff
		// 81 00 08 30 75 00 00 07 00 ff ff 04 00 23 00 31 00 00 00 00 00 00 00
		// 00 00 00 00 40 ae 00 00 02 04 00 00 00 00 00 1e 00 00 00 00 00 0c 00
		// 01 00 06 00 20 29 01 00 00 00";
		...
		// String s =
		// "81 04 00 21 0a 14 01 05 ba c0 01 28 ff ff 00 00 0b 01 01 fe 10 00 c4
		// 02 00 2a f9 21 80 91 03 21 12";
		// String s =
		// "81 04 00 21 0a 14 01 05 ba c0 01 28 ff ff 00 00 0d 01 19 fe 10 00 c4
		// 02 00 32 e1 21 80 91 03 21 12";
