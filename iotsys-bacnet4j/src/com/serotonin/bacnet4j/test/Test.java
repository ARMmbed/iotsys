...
public class Test {
	...
	//
	// ObjectIdentifier oid = new ObjectIdentifier(ObjectType.multiStateOutput,
	// 0);
	...
	// System.out.println("" + opr.getPropertyIdentifier() + ": " +
	...
	// e.printStackTrace();
	// }
	// System.out.println("Total test time: "+ (System.currentTimeMillis() -
	// start) +"ms");
	// Thread.sleep(2000);
	// d.terminate();
	// }
	...
	public static void test3(LocalDevice d) throws Exception {
		RemoteDevice rd = new RemoteDevice(105,
				new Address(new byte[] { (byte) 206, (byte) 210, 100, (byte) 134 }, 47808), null);
		...
		// ((SequenceOf<ObjectIdentifier>)d.sendReadPropertyAllowNull(
		// rd, rd.getObjectIdentifier(),
	...
	public static void test(LocalDevice d) throws Exception {
		...
		System.out.println(
				send(d, new ReadPropertyRequest(device, PropertyIdentifier.objectList, new UnsignedInteger(0))));
		System.out.println(
				send(d, new ReadPropertyRequest(device, PropertyIdentifier.objectList, new UnsignedInteger(1))));
		System.out.println(
				send(d, new ReadPropertyRequest(device, PropertyIdentifier.objectList, new UnsignedInteger(2))));
		...
		System.out.println(send(d, new WritePropertyRequest(created, PropertyIdentifier.presentValue, null,
				new Real(5.5f), new UnsignedInteger(5))));
		...
		// Read a value
		System.out.println(send(d, new ReadPropertyRequest(created, PropertyIdentifier.presentValue, null)));
		// ObjectIdentifier oi = new ObjectIdentifier(ObjectType.analogInput,
		// 0);
		...
		// obj.setProperty(new PropertyValue(PropertyIdentifier.description, new
		// CharacterString(description)));
		// obj.setProperty(new PropertyValue(PropertyIdentifier.presentValue,
		// new Real(155.2f)));
		// obj.setProperty(new PropertyValue(PropertyIdentifier.units,
		// EngineeringUnits.centimetersOfMercury));
		// d.addObject(obj);
		// System.out.println(send(d, new ReadPropertyRequest(created,
		// PropertyIdentifier.description, null)));
		System.out.println(send(d, new ReadPropertyRequest(device, PropertyIdentifier.objectName, null)));
		...
		// null));
		// refs.add(new PropertyReference(PropertyIdentifier.objectName, new
		// UnsignedInteger(0)));
		// refs.add(new PropertyReference(PropertyIdentifier.units, new
		// UnsignedInteger(1)));
		// refs.add(new PropertyReference(PropertyIdentifier.presentValue, new
		// UnsignedInteger(2)));
	...
	public static void test2(LocalDevice d) throws Exception {
		...
		// System.out.println(send(d, rd, new AddListElementRequest(nc0,
		// PropertyIdentifier.recipientList, new
	...
	// public void run() {
	// try {
	// System.out.println("Response for 1: "+ mc1.sendConfirmed(10002,
	// (byte)1));
	// System.out.println("Response for 1: "+ mc1.sendConfirmed(10003,
	// (byte)11));
	// System.out.println("Response for 1: "+ mc1.sendConfirmed(10004,
	// (byte)21));
	// System.out.println("Response for 1: "+ mc1.sendConfirmed(10005,
	// (byte)31));
	...
	// public void run() {
	// try {
	// System.out.println("Response for 2: "+ mc2.sendConfirmed(10001,
	// (byte)2));
	// System.out.println("Response for 2: "+ mc2.sendConfirmed(10003,
	// (byte)12));
	// System.out.println("Response for 2: "+ mc2.sendConfirmed(10004,
	// (byte)22));
	// System.out.println("Response for 2: "+ mc2.sendConfirmed(10005,
	// (byte)32));
	// }
	// catch (Exception e) {
	// e.printStackTrace();
	...
	// public void run() {
	// try {
	// System.out.println("Response for 3: "+ mc3.sendConfirmed(10001,
	// (byte)3));
	// System.out.println("Response for 3: "+ mc3.sendConfirmed(10002,
	// (byte)13));
	// System.out.println("Response for 3: "+ mc3.sendConfirmed(10004,
	// (byte)23));
	// System.out.println("Response for 3: "+ mc3.sendConfirmed(10005,
	// (byte)33));
	// }
	// catch (Exception e) {
	// e.printStackTrace();
	...
	// public void run() {
	// try {
	// System.out.println("Response for 4: "+ mc4.sendConfirmed(10001,
	// (byte)4));
	// System.out.println("Response for 4: "+ mc4.sendConfirmed(10002,
	// (byte)14));
	// System.out.println("Response for 4: "+ mc4.sendConfirmed(10003,
	// (byte)24));
	// System.out.println("Response for 4: "+ mc4.sendConfirmed(10005,
	// (byte)34));
	// }
	// catch (Exception e) {
	// e.printStackTrace();
	...
	// public void run() {
	// try {
	// System.out.println("Response for 5: "+ mc5.sendConfirmed(10001,
	// (byte)5));
	// System.out.println("Response for 5: "+ mc5.sendConfirmed(10002,
	// (byte)15));
	// System.out.println("Response for 5: "+ mc5.sendConfirmed(10003,
	// (byte)25));
	// System.out.println("Response for 5: "+ mc5.sendConfirmed(10005,
	// (byte)35));
	// }
	// catch (Exception e) {
	// e.printStackTrace();
	...
	// public static void main(String[] args) throws Exception {
	// Service s = new ReadPropertyRequest(new
	// ObjectIdentifier(AnalogInput.TYPE_ID, 0),
	// PropertyIdentifier.presentValue, null);
	// APDU apdu = new ConfirmedRequest(false, false, false, 0,
	// MaxApduLength.UP_TO_50, 21, 0, 0, s);
	...
	// System.out.println(ArrayUtils.toHexString(packet.getData(),
	...
	// // Send
	// byte[] data = {
	// // (byte)0xc0, (byte)0xa8, (byte)0x64, (byte)0xff, (byte)0xba,
	// (byte)0xc0, (byte)0x81, (byte)0x0b,
	// // (byte)0x00, (byte)0x18, (byte)0x01, (byte)0x20, (byte)0xff,
	// (byte)0xff, (byte)0x00, (byte)0xff,
	// // (byte)0x10, (byte)0x00, (byte)0xc4, (byte)0x02, (byte)0x00,
	// (byte)0x00, (byte)0x00, (byte)0x22,
	// // (byte)0x04, (byte)0x00, (byte)0x91, (byte)0x03, (byte)0x21, (byte)0x0f
	//
	// // (byte)0x1, (byte)0x20, (byte)0xff, (byte)0xff, (byte)0x0, (byte)0xff,
	// (byte)0x10, (byte)0x0,
	// // (byte)0xc4, (byte)0x2, (byte)0x0, (byte)0x0, (byte)0x3, (byte)0x22,
	// (byte)0x4, (byte)0x0,
	// // (byte)0x91, (byte)0x3, (byte)0x21, (byte)0x63
	//
	// // (byte)0x7f, (byte)0x00, (byte)0x00, (byte)0x01, (byte)0xba,
	// (byte)0xc0,
	// // (byte)0x81, (byte)0x0a, (byte)0x00, (byte)0x11, (byte)0x01,
	// (byte)0x04, (byte)0x00, (byte)0x00,
	// // (byte)0x12, (byte)0x0c, (byte)0x0c, (byte)0x00, (byte)0x00,
	...
	// // (byte)0x55
	//
	// // (byte)0x01, (byte)0x04, (byte)0x30, (byte)0x37, (byte)0x0c,
	// (byte)0x0c, (byte)0x00, (byte)0x00,
	// // (byte)0x00, (byte)0x00, (byte)0x19, (byte)0x55, (byte)0x3e,
	// (byte)0x44, (byte)0x44, (byte)0x9a,
	// // (byte)0x52, (byte)0x2b, (byte)0x3f
	//
	// (byte)0x01, (byte)0x04,
	// (byte)0x00, (byte)0x00, (byte)0x15, (byte)0x0c, (byte)0x0c, (byte)0x00,
	// (byte)0x00, (byte)0x00,
