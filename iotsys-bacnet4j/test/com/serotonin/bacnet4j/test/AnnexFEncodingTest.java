...
public class AnnexFEncodingTest {
	...
	public void e1_1aTest() {
		...
		ConfirmedRequest pdu = new ConfirmedRequest(false, false, false, 0, MaxApduLength.UP_TO_206, (byte) 7, (byte) 0,
				0, acknowledgeAlarmRequest);
	...
	public void e1_6aTest() {
		...
		ConfirmedRequest pdu = new ConfirmedRequest(false, false, false, 0, MaxApduLength.UP_TO_206, (byte) 1, (byte) 0,
				0, getAlarmSummaryRequest);
	...
	public void e1_7cTest() {
		...
		ConfirmedRequest pdu = new ConfirmedRequest(false, false, false, 0, MaxApduLength.UP_TO_206, (byte) 2, (byte) 0,
				0, getEnrollmentSummaryRequest);
	...
	public void e1_8bTest() {
		...
		eventSummaries.add(new GetEventInformationAck.EventSummary(new ObjectIdentifier(ObjectType.analogInput, 2),
				...
				new TimeStamp(new Time(255, 255, 255, 255)), NotifyType.alarm,
	...
	public void e2_1aTest() {
		...
		APDU pdu = new ConfirmedRequest(false, false, false, 0, MaxApduLength.UP_TO_206, (byte) 0, (byte) 0, 0,
				service);
	...
	public void e4_2aTest() {
		...
		ConfirmedPrivateTransferRequest.vendorServiceResolutions
	...
	public void e4_3Test() {
		...
		UnconfirmedPrivateTransferRequest.vendorServiceResolutions
				.put(new VendorServiceKey(new UnsignedInteger(25), new UnsignedInteger(8)), def);
	...
	public void e4_4aTest() {
		...
		APDU pdu = new ConfirmedRequest(false, false, false, 0, MaxApduLength.UP_TO_128, (byte) 2, (byte) 0, 0,
				service);
	...
	public void e4_5aTest() {
		...
		APDU pdu = new ConfirmedRequest(false, false, false, 0, MaxApduLength.UP_TO_128, (byte) 3, (byte) 0, 0,
				service);
	...
	public void e6_aTest() {
		ConfirmedRequestService service = new RequestKeyRequest(new ObjectIdentifier(ObjectType.device, 1),
				...
				new Address(new Unsigned16(2), new OctetString(new byte[] { 34 })));
