...
public class HistoryServiceTest extends AbstractGatewayTest {
	...
	public void testHistoryObj() {
		expect().body(hasXPath("/obj[@is='obix:History']")).body(hasXPath("/obj/int[@name='count']"))
				...
				.body(hasXPath(
						"/obj/op[@name='rollup' and @in='obix:HistoryRollupIn' and @out='obix:HistoryRollupOut']"))
				.body(hasXPath(
						"/obj/op[@name='append' and @in='obix:HistoryAppendIn' and @out='obix:HistoryAppendOut']"))
	...
	public void testHistoryQuery() {
		given().contentType(ContentType.XML)
				.body("<obj is='obix:HistoryFilter'>" + "	<int name='limit' val='2'/>"
						+ "	<abstime name='start' val='2013-03-31T15:30:00+02:00' tz='Europe/Berlin'/>"
						+ "	<abstime name='end' null='true' tz='Europe/Berlin'/>" + "</obj>")
				.expect().body(hasXPath("/obj[@is='obix:HistoryQueryOut']"))
		...
		given().contentType(ContentType.XML)
				...
				.expect().body(hasXPath("/obj/int[@name='count' and @val='2']"))
				.body(hasXPath("/obj/abstime[@name='start' and not(@null)]"))
				.body(hasXPath("/obj/abstime[@name='end' and not(@null)]"))
				.body(hasXPath("/obj/list[@of='obix:HistoryRecord']")).body(hasXPath("/obj/list[count(obj) = 2]"))
				.body(hasXPath("/obj/list/obj[1]/int[@val=2]")).body(hasXPath("/obj/list/obj[2]/int[@val=3]"))
				.post("/testDevicesHistory/brightnessHistoryQuery/value/history/query");
	}
	...
	public void testHistoryAppend() {
		...
		response = given().contentType(ContentType.XML)
				.body("<obj is='obix:HistoryAppendIn'>" + "	<list name='data' of='obix:HistoryRecord'>" + "		<obj>"
						+ "			<abstime name='timestamp' val='2013-07-10T10:15:00-05:00'/>"
						+ "			<int name='value' val='2'/>" + "		</obj>" + "		<obj>"
						+ "			<abstime name='timestamp' val='2013-07-10T10:30:00-05:00'/>"
						+ "			<int val='3'/>" + "		</obj>" + "	</list>" + "</obj>")
				.expect().body(hasXPath("/obj[@is='obix:HistoryAppendOut']"))
		...
		long start = DatatypeConverter.parseDateTime(XmlPath.from(response).getString("obj.abstime[0].@val"))
				.getTimeInMillis();
		long end = DatatypeConverter.parseDateTime(XmlPath.from(response).getString("obj.abstime[1].@val"))
				.getTimeInMillis();
		...
		response = given().contentType(ContentType.XML)
				.body("<obj is='obix:HistoryAppendIn'>" + "	<list name='data' of='obix:HistoryRecord'>" + "		<obj>"
						...
						+ "			<int name='value' val='4'/>" + "		</obj>" + "	</list>" + "</obj>")
				.expect().body(hasXPath("/obj[@is='obix:HistoryAppendOut']"))
				.body(hasXPath("/obj/int[@name='numAdded' and @val='1']"))
				.body(hasXPath("/obj/int[@name='newCount' and @val='3']"))
				.post("/testDevicesHistory/brightnessHistory2/value/history/append").asString();

		end = DatatypeConverter.parseDateTime(XmlPath.from(response).getString("obj.abstime[0].@val"))
				.getTimeInMillis();
		end = DatatypeConverter.parseDateTime(XmlPath.from(response).getString("obj.abstime[1].@val"))
				.getTimeInMillis();
	...
	public void testHistoryAppendBeforeLastShouldFail() {
		given().param("data",
				"<obj is='obix:HistoryAppendIn'>" + "	<list name='data' of='obix:HistoryRecord'>" + "		<obj>"
						+ "			<abstime name='timestamp' val='2013-07-10T10:15:00-05:00'/>"
						+ "			<int name='value' val='2'/>" + "		</obj>" + "	</list>" + "</obj>")
				.expect().body(not(hasXPath("/err")))
				.post("/testDevicesHistory/brightnessHistory3/value/history/append");

		given().param("data",
				"<obj is='obix:HistoryAppendIn'>" + "	<list name='data' of='obix:HistoryRecord'>" + "		<obj>"
						+ "			<abstime name='timestamp' val='2013-07-05T10:00:00-05:00'/>"
						+ "			<int name='value' val='1'/>" + "		</obj>" + "	</list>" + "</obj>")
				.expect().body(hasXPath("/err")).post("/testDevicesHistory/brightnessHistory3/value/history/append");
	}
	...
	public void testHistoryAppendFuture() {
		...
		given().contentType(ContentType.XML)
				.body("<obj is='obix:HistoryAppendIn'>" + "	<list name='data' of='obix:HistoryRecord'>" + "		<obj>"
						...
						+ "			<int name='value' val='3'/>" + "		</obj>" + "	</list>" + "</obj>")
				.expect().body(hasXPath("/obj[@is='obix:HistoryAppendOut']"))
				.body(hasXPath("/obj/int[@name='numAdded' and @val='1']"))
				.body(hasXPath("/obj/int[@name='newCount' and @val='1']"))
				.body(hasXPath("/obj/abstime[@name='newStart' and not(@null)]"))
	...
	public void testHistoryStartAndEnd() {
		expect().body(hasXPath("/obj[@is='obix:History']")).body(hasXPath("/obj/int[@name='count' and @val=0]"))
				.body(hasXPath("/obj/abstime[@name='start' and @null='true']"))
				.body(hasXPath("/obj/abstime[@name='end' and @null='true']")).when()
		...
		String response = expect().body(hasXPath("/obj[@is='obix:History']"))
				.body(hasXPath("/obj/int[@name='count' and @val=1]"))
				.body(not(hasXPath("/obj/abstime[@name='start'][@null]")))
				.body(not(hasXPath("/obj/abstime[@name='end'][@null]"))).when()
				.get("/testDevicesHistory/brightnessHistoryStartEnd/value/history").asString();
		...
		given().contentType(ContentType.XML)
				.body("<obj is='obix:HistoryAppendIn'>" + "	<list name='data' of='obix:HistoryRecord'>" + "		<obj>"
						...
						+ "			<int name='value' val='5'/>" + "		</obj>" + "	</list>" + "</obj>")
				.expect().body(not(hasXPath("/err")))
				.post("/testDevicesHistory/brightnessHistoryStartEnd/value/history/append");

		response = expect().body(hasXPath("/obj[@is='obix:History']"))
				.body(hasXPath("/obj/int[@name='count' and @val=2]"))
				.body(not(hasXPath("/obj/abstime[@name='start' and @null]")))
				.body(not(hasXPath("/obj/abstime[@name='end' and @null]"))).when()
				.get("/testDevicesHistory/brightnessHistoryStartEnd/value/history").asString();

		start = DatatypeConverter.parseDateTime(XmlPath.from(response).getString("obj.abstime[0].@val"))
				.getTimeInMillis();
		end = DatatypeConverter.parseDateTime(XmlPath.from(response).getString("obj.abstime[1].@val"))
				.getTimeInMillis();
	...
	public void testHistoryRollup() {
		...
		given().contentType(ContentType.XML)
				.body("<obj is='obix:HistoryRollupIn'> " + "  <int name='limit' val='2'/>"
						+ "  <abstime name='start' val='2013-03-31T15:30:00+02:00' tz='Europe/Berlin'/>"
						+ "  <abstime name='end' null='true' />" + "  <reltime name='interval' val='PT15M'/>"
						+ "</obj>")
				.expect().body(hasXPath("/obj[@is='obix:HistoryRollupOut']")).body(hasXPath("/obj/int[@name='count']"))
				.body(hasXPath("/obj/abstime[@name='start' and not(@null)]"))
				.body(hasXPath("/obj/abstime[@name='end' and not(@null)]"))
	...
	public void testHistoryRollupBoolShouldFail() {
		...
		given().param("data",
				"<obj is='obix:HistoryRollupIn'> " + "  <int name='limit' val='2'/>"
						+ "  <abstime name='start' val='2013-03-31T15:30:00+02:00' tz='Europe/Vienna'/>"
						+ "  <reltime name='interval' val='PT15M'/>" + "</obj>")
				.expect().body(hasXPath("/err")).post("/testDevicesHistory/switch1/value/history/rollup");
	}

	@Test
	public void testHistoryRollupMultipleRecords() {
		given().contentType(ContentType.XML)
				.body("<obj is='obix:HistoryAppendIn'>" + "	<list name='data' of='obix:HistoryRecord'>"
						...
						+ "		<real name='value' val='78'/> </obj>" + "	</list>" + "</obj>")
				.expect().body(not(hasXPath("/err"))).post("/testDevicesHistory/tempHistory/value/history/append");

		String response = given().contentType(ContentType.XML)
				.body("<obj is='obix:HistoryRollupIn'> " + "  <abstime name='start' val='2005-03-16T12:00:00Z'/>"
						+ "  <abstime name='end' val='2005-03-16T14:00:00Z' />"
						+ "  <reltime name='interval' val='PT1H'/>" + "</obj>")
				.expect().body(hasXPath("/obj[@is='obix:HistoryRollupOut']"))
		...
		timestamp = DatatypeConverter.parseDateTime(XmlPath.from(response).getString("obj.abstime[0].@val"))
				.getTimeInMillis();
		assertEquals(timestamp, DatatypeConverter.parseDateTime("2005-03-16T12:00:00Z").getTimeInMillis());

		timestamp = DatatypeConverter.parseDateTime(XmlPath.from(response).getString("obj.abstime[1].@val"))
				.getTimeInMillis();
		assertEquals(timestamp, DatatypeConverter.parseDateTime("2005-03-16T14:00:00Z").getTimeInMillis());

		timestamp = DatatypeConverter.parseDateTime(XmlPath.from(response).getString("obj.list.obj[0].abstime[0].@val"))
				.getTimeInMillis();
		assertEquals(timestamp, DatatypeConverter.parseDateTime("2005-03-16T12:00:00Z").getTimeInMillis());

		timestamp = DatatypeConverter.parseDateTime(XmlPath.from(response).getString("obj.list.obj[0].abstime[1].@val"))
				.getTimeInMillis();
		assertEquals(timestamp, DatatypeConverter.parseDateTime("2005-03-16T13:00:00Z").getTimeInMillis());

		timestamp = DatatypeConverter.parseDateTime(XmlPath.from(response).getString("obj.list.obj[1].abstime[0].@val"))
				.getTimeInMillis();
		assertEquals(timestamp, DatatypeConverter.parseDateTime("2005-03-16T13:00:00Z").getTimeInMillis());

		timestamp = DatatypeConverter.parseDateTime(XmlPath.from(response).getString("obj.list.obj[1].abstime[1].@val"))
				.getTimeInMillis();
		assertEquals(timestamp, DatatypeConverter.parseDateTime("2005-03-16T14:00:00Z").getTimeInMillis());
	}
	...
	public void testHistoryTimezones() {
		String history = expect().body(hasXPath("/obj[@is='obix:History']")).body(hasXPath("/obj/str[@name='tz']"))
		...
		given().contentType(ContentType.XML)
				.body("<obj is='obix:HistoryRollupIn'> " + "  <int name='limit' val='2'/>"
						...
						+ "  <abstime name='end' null='true' />" + "  <reltime name='interval' val='PT2H'/>" + "</obj>")
				.expect().body(hasXPath("/obj[@is='obix:HistoryRollupOut']"))
				.body(hasXPath("/obj/abstime[@name='start' and @tz='" + timezone + "']"))
				.body(hasXPath("/obj/abstime[@name='end' and @tz='" + timezone + "']"))
