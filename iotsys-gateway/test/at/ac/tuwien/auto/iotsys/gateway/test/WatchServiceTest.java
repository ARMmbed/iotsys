...
public class WatchServiceTest extends AbstractGatewayTest {
	...
	public void testLobbyHasWatchService() {
		...
		expect().body(hasXPath("/obj/ref[@href='watchService' and @is='obix:WatchService']")).when().get("/obix");
		// }
	}
	...
	public void testMakeWatch() {
		expect().body(hasXPath("/obj[@is='obix:Watch']")).body(hasXPath("/obj/reltime[@name='lease']"))
				...
				.body(hasXPath("/obj/op[@name='delete']")).when().post("/watchService/make");
	}
	...
	public void testWatchAddSingleObj() {
		...
		given().contentType(ContentType.XML)
				.body("<obj is='obix:WatchIn'>" + "	<list name='hrefs'>"
						+ "		<uri val='/testDevicesWatch/switchWatch1/value' />" + "	</list>" + "</obj>")
	...
	public void testWatchAddSingleObjJson() {
		...
		given().contentType("application/json").header("accept", "application/json")
				...
				.expect().body(containsString("\"is\":\"obix:WatchOut\""))
				.body(containsString(
						"{\"val\":false,\"tag\":\"bool\",\"writable\":true,\"displayName\":\"On/Off\",\"href\":\"/testDevices/switch3/value\"}"))
				.post(watchHref + "/add");
	}
	...
	public void testWatchAddMultipleObjs() {
		...
		given().contentType(ContentType.XML)
				.body("<obj is='obix:WatchIn'>" + "	<list name='hrefs'>"
						...
						+ "		<uri val='/testDevicesWatch/switchWatch2/value' />" + "	</list>" + "</obj>")
				.expect().body(hasXPath("/obj[@is='obix:WatchOut']"))
	...
	public void testWatchPollChanges() {
		...
		// No changes yet
		expect().body(hasXPath("/obj[@is='obix:WatchOut']")).body(not(hasXPath("/obj/list/bool"))).when().post(pollUri);
		...
		given().expect().body(hasXPath("/obj[@is='obix:WatchOut']"))
				.body(hasXPath("/obj/list/bool[@val='true' and @href='/testDevicesWatch/switchWatch1/value']"))
				.contentType(ContentType.XML).when().post(pollUri);
		...
		given().expect().body(hasXPath("/obj[@is='obix:WatchOut']"))
				...
				.body(hasXPath("/obj/list/bool[@val='true' and @href='/testDevicesWatch/switchWatch2/value']")).when()
				.post(pollUri);
	}
	...
	public void testWatchPollRefresh() {
		...
		expect().body(hasXPath("/obj[@is='obix:WatchOut']"))
				.body(hasXPath("/obj/list/bool[@href='/testDevicesWatch/switchWatch1/value']"))
				.body(hasXPath("/obj/list/bool[@href='/testDevicesWatch/switchWatch2/value']")).when().post(pollUri);
		...
		expect().body(hasXPath("/obj[@is='obix:WatchOut']")).body(not(hasXPath("/obj/list/bool"))).when()
				.post(pollChangesUri);
	}
	...
	public void testWatchWriteLease() {
		...
		given().body("<reltime href='lease' val='PT42S' />").expect()
				.body(hasXPath("//reltime[@name='lease' and @val='PT42S']")).when().put(watchHref);
	}
	...
	public void testWatchLeaseExpiration() throws InterruptedException {
		...
		given().body("<reltime href='lease' val='PT1S' />").expect()
				.body(hasXPath("//reltime[@name='lease' and @val='PT1S']")).when().put(watchHref);
	...
	public void testWatchRemove() {
		...
		given().contentType(ContentType.XML)
				.body("<obj is='obix:WatchIn'>" + "	<list name='hrefs'>"
						+ "		<uri val='/testDevicesWatch/switchWatch1/value' />" + "	</list>" + "</obj>")
				.expect().body(hasXPath("/obj[@is='obix:Nil']")).post(watchHref + "/remove");

		expect().body(not(hasXPath("//bool[@href='/testDevicesWatch/switchWatch1/value']")))
				.body(hasXPath("//bool[@href='/testDevicesWatch/switchWatch2/value']"))
				.body(hasXPath("//obj[@href='/testDevices/brightnessSensor1']")).post(watchHref + "/pollRefresh");
	}
	...
	public void testWatchDelete() {
		...
		expect().body(hasXPath("/obj[@is='obix:Nil']")).post(watchHref + "/delete");
	...
	public void testWatchAddFeed() {
		...
		given().contentType(ContentType.XML)
				...
				.expect().body(hasXPath("/obj[@is='obix:WatchOut']"))
				.body(hasXPath(
						"/obj/list/feed[@href='/testDevicesWatch/fanSpeedWatchAdd/fanSpeedSetpoint/history/feed' and @of='obix:HistoryRecord']"))
				.body(hasXPath("/obj/list/feed[count(obj) = 3]")).body(hasXPath("/obj/list/feed/obj[1]/int[@val='3']"))
				.body(hasXPath("/obj/list/feed/obj[2]/int[@val='2']"))
				.body(hasXPath("/obj/list/feed/obj[3]/int[@val='1']")).post(watchHref + "/add");
	}
	...
	public void testWatchFeedPollRefresh() {
		...
		given().contentType(ContentType.XML)
				...
				.expect().body(hasXPath("/obj[@is='obix:WatchOut']"))
				.body(hasXPath(
						"/obj/list/feed[@href='/testDevicesWatch/fanSpeedWatchPollRefresh/fanSpeedSetpoint/history/feed' and @of='obix:HistoryRecord']"))
				.post(watchHref + "/add");
		...
		expect().body(hasXPath("/obj/list/feed[count(obj) = 6]")).body(hasXPath("/obj/list/feed/obj[1]/int[@val='6']"))
				...
				.body(hasXPath("/obj/list/feed/obj[6]/int[@val='1']")).post(pollUri);
	...
	public void testWatchFeedPollChanges() {
		...
		given().contentType(ContentType.XML)
				...
				.expect().body(hasXPath("/obj[@is='obix:WatchOut']"))
				.body(hasXPath(
						"/obj/list/feed[@href='/testDevicesWatch/fanSpeedWatchPollChanges/fanSpeedSetpoint/history/feed' and @of='obix:HistoryRecord']"))
				.body(hasXPath("/obj/list/feed[count(obj) = 3]")).body(hasXPath("/obj/list/feed/obj[1]/int[@val='3']"))
				.body(hasXPath("/obj/list/feed/obj[2]/int[@val='2']"))
				.body(hasXPath("/obj/list/feed/obj[3]/int[@val='1']")).post(addUri);
		...
		expect().body(hasXPath("/obj/list/feed[count(obj) = 3]")).body(hasXPath("/obj/list/feed/obj[1]/int[@val='6']"))
				.body(hasXPath("/obj/list/feed/obj[2]/int[@val='5']"))
				.body(hasXPath("/obj/list/feed/obj[3]/int[@val='4']")).post(pollChangesUri);
	...
	public void testWatchExtent() {
		...
		given().contentType(ContentType.XML)
				.body("<obj is='obix:WatchIn'>" + "	<list name='hrefs'>"
						+ "		<uri val='/testDevicesWatch/fanSpeedWatchExtent'/>" + "	</list>" + "</obj>")
				.expect().body(hasXPath("/obj[@is='obix:WatchOut']"))
				.body(hasXPath("/obj/list/obj[@href='/testDevicesWatch/fanSpeedWatchExtent']")).post(addUri);

		given().body("<int val='42' />").put("/testDevicesWatch/fanSpeedWatchExtent/fanSpeedSetpoint");

		expect().body(hasXPath("/obj/list/obj[@href='/testDevicesWatch/fanSpeedWatchExtent']"))
				.body(hasXPath("/obj/list/obj/int[@val=42]")).post(pollChangesUri);
	}
	...
	public void testWatchHistoryFeedFiltered() {
		...
		given().contentType(ContentType.XML)
				.body("<obj is='obix:WatchIn'>" + "	<list name='hrefs'>"
						...
						+ "			<obj is='obix:HistoryFilter'>" + "				<int name='limit' val='3' />"
						+ "			</obj>" + "		</uri>" + "	</list>" + "</obj>")
				.expect().body(hasXPath("/obj[@is='obix:WatchOut']"))
				.body(hasXPath(
						"/obj/list/feed[@href='/testDevicesWatch/fanSpeedWatchFilter/fanSpeedSetpoint/history/feed' and @of='obix:HistoryRecord']"))
				.body(hasXPath("/obj/list/feed[count(obj) = 3]")).body(hasXPath("/obj/list/feed/obj[1]/int[@val=5]"))
				.body(hasXPath("/obj/list/feed/obj[2]/int[@val=4]")).body(hasXPath("/obj/list/feed/obj[3]/int[@val=3]"))
				.post(addUri);

		// pollChanges has no new events
		expect().body(not(hasXPath("/obj/list/feed"))).post(pollChangesUri);

		expect().body(hasXPath("/obj/list/feed[count(obj) = 3]")).body(hasXPath("/obj/list/feed/obj[1]/int[@val=5]"))
				.body(hasXPath("/obj/list/feed/obj[2]/int[@val=4]")).body(hasXPath("/obj/list/feed/obj[3]/int[@val=3]"))
				.post(pollRefreshUri);
		...
		expect().body(hasXPath("/obj/list/feed[count(obj) = 3]")).body(hasXPath("/obj/list/feed/obj[1]/int[@val=9]"))
				.body(hasXPath("/obj/list/feed/obj[2]/int[@val=8]")).body(hasXPath("/obj/list/feed/obj[3]/int[@val=7]"))
				.post(pollChangesUri);
	}
	...
	public void testHistoryFeedFuture() {
		...
		String appendEvent = "<obj is='obix:HistoryAppendIn'>" + "	<list name='data' of='obix:HistoryRecord'>"
				+ "		<obj>" + "			<abstime name='timestamp' val='%s'/>"
				+ "			<int name='value' val='%d'/>" + "		</obj>" + "	</list>" + "</obj>";
		...
		given().contentType(ContentType.XML)
				.body("<obj is='obix:WatchIn'>" + "	<list name='hrefs'>"
						...
						+ "	</list>" + "</obj>")
				.expect().body(hasXPath("/obj[@is='obix:WatchOut']")).post(addUri);
		...
		expect().body(hasXPath("/obj/list/feed")).body(hasXPath("/obj/list/feed/obj[1]/int[@val=5]"))
				.body(hasXPath("/obj/list/feed/obj[2]/int[@val=1]")).post(pollChangesUri);

		given().body("<int val='2' />").put("/testDevicesHistory/brightnessHistoryFeedFuture/value");

		expect().body(hasXPath("/obj/list/feed")).body(hasXPath("/obj/list/feed/obj[1]/int[@val=2]"))
				.post(pollChangesUri);
		...
		expect().body(hasXPath("/obj/list/feed")).body(hasXPath("/obj/list/feed/obj[1]/int[@val=4]"))
				.body(hasXPath("/obj/list/feed/obj[2]/int[@val=3]")).post(pollChangesUri);

		expect().body(hasXPath("/obj/list/feed")).body(hasXPath("/obj/list/feed/obj[1]/int[@val=5]"))
				.body(hasXPath("/obj/list/feed/obj[2]/int[@val=4]")).body(hasXPath("/obj/list/feed/obj[3]/int[@val=3]"))
				.body(hasXPath("/obj/list/feed/obj[4]/int[@val=2]")).body(hasXPath("/obj/list/feed/obj[5]/int[@val=1]"))
				.post(pollRefreshUri);
	}
}
