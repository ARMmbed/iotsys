...
/**
 * A command line arguments parsing tool. Can set required and optional
 * arguments. To use it, first construct it by calling constructors, then call
 * parse method to parsing command line. Argument's token is case-insensitive,
...
public class CommandLineArguments {
	...
	/**
	 * Whether or not allow undefined arguments exist in command line. True is
	...
	/**
	 * Parsing the command line, and add the parsed arguments to a Map. If there
	 * are invalid arguments and we don't allow them exist, an
	 * InvalidCommandLineArgumentException will be thrown. If not all required
	 * arguments are present, a MissingRequiredArgumentsException will be
	 * thrown.
	 * 
	 * @param commandLine
	...
	public void parse(String commandLine)
			throws InvalidCommandLineArgumentException, MissingRequiredArgumentsException {
