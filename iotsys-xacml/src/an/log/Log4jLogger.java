...
/**
 * The logger employs Log4j as its implementation. It requires log4j.jar in
 * classpath. User who want to use this logger can configure log4j as direct use
 * it. For example, just put a log4j.properties to classpath, the logger can
 * work.
 */
