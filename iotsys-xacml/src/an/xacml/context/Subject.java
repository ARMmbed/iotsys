...
public class Subject extends TargetElement {
	/**
	 * The category has a default value if it is not present in request element.
	 * So it won't be null.
	 */
	...
	public boolean equals(Object o) {
		...
		if (o != null && o.getClass() == this.getClass()) {
			...
			if (subjectCategory.equals(other.getSubjectCategory()) && attributes.size() == other.attributes.size()) {
