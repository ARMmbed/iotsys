...
public class Attribute extends DefaultXACMLElement {
	...
	/**
	 * At least one AttributeValue should be present. So we always won't get
	 * null for this field.
	 */
	private Object[] typedValues;

	/**
	 * Since XACML 2.0 doesn't restrict the context AttributeValue, so it can be
	 * any value. So we just pass the values as String[], it comes from the text
	 * between &ltAttributeValue&gt and &ltAttributeValue/&gt.
	 * 
	 * @param attrId
	 * @param xmlType
	 * @param issuer
	...
	public boolean equals(Object o) {
		...
		if (o != null && o.getClass() == this.getClass()) {
			...
			if (attributeId.equals(other.getAttributeID()) && (issuer != null && issuer.equals(other.getIssuer()))
					&& typedValues != null && otherValues != null && typedValues.length == otherValues.length) {
