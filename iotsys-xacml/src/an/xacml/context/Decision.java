...
public enum Decision implements XACMLElement {
	 ...
	 * 
	 * @param effect
	 *            The Effect type object
	 * @return
	 */
	public boolean equals(Effect effect) {
		if (effect != null
				&& ((effect == Effect.Permit && this == Permit) || (effect == Effect.Deny && this == Deny))) {
			return true;
		}
		return false;
	}
	...
	/**
	 * This method is used to make use of "getVersion" method of DefaultElement
	 */
	...
	public XACMLElement getRootElement() {
		// Since we don't need parse Response, and this element doesn't make use
		// of root element, we don't support the
	...
	public XACMLElement getParentElement() {
		// Since we don't need parse Response, and this element doesn't make use
		// of parent element, we don't support the
		// operation at this element.
