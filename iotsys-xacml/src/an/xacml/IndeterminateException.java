...
/**
 * This class represent the Indeterminate error during the matching or
 * evaluating process.
 */
public class IndeterminateException extends Exception {
	...
	/**
	 * The caller could attach an object that include all detailed information
	 * about the exception, the exception receiver then could retrieve and
	 * process it with the final desicion.
	 */
