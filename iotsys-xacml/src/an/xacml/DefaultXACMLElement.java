...
public abstract class DefaultXACMLElement implements XACMLElement {
	...
	static {
		...
		// Below data types are added in errata published at 29 Jan, 2008. To
		// keep compatibility with the core standard
		// (especially for conformance test), we will support both these types
	...
	/**
	 * Return the root XACML element. The root element should be
	 * RequestElement(for context elements) or Policy/PolicySet element(for
	 * policy elements).
	 * 
	...
	/**
	 * Return the direct parent XACML element. The parent element should be
	 * passed from element's constructor.
	 */
	...
	/*
	 * public synchronized void setAttribute(String key, Object value) { if
	 * (attributes == null) { attributes = new HashMap<String, Object>(); }
	 * attributes.put(key, value); }
	 * 
	 * public synchronized Object getAttribute(String key) { if (attributes !=
	 * null) { return attributes.get(key); } return null; }
	 */
