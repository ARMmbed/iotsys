...
public abstract class HighOrderBagFunctions {
	...
	public static AttributeValue anyOf(EvaluationContext ctx, Object[] params) throws IndeterminateException {
	...
	public static AttributeValue allOf(EvaluationContext ctx, Object[] params) throws IndeterminateException {
		checkArguments(params, 3);
		AttributeValue funcId = (AttributeValue) params[0];
		AttributeValue o = (AttributeValue) params[1];
		AttributeValue[] bag = (AttributeValue[]) params[2];
	...
	public static AttributeValue anyOfAny(EvaluationContext ctx, Object[] params) throws IndeterminateException {
		checkArguments(params, 3);
		AttributeValue funcId = (AttributeValue) params[0];
	...
	public static AttributeValue allOfAny(EvaluationContext ctx, Object[] params) throws IndeterminateException {
		checkArguments(params, 3);
		AttributeValue funcId = (AttributeValue) params[0];
		AttributeValue[] bag1 = (AttributeValue[]) params[1];
		AttributeValue[] bag2 = (AttributeValue[]) params[2];
	...
	public static AttributeValue anyOfAll(EvaluationContext ctx, Object[] params) throws IndeterminateException {
		checkArguments(params, 3);
		AttributeValue funcId = (AttributeValue) params[0];
		AttributeValue[] bag1 = (AttributeValue[]) params[1];
		AttributeValue[] bag2 = (AttributeValue[]) params[2];
	...
	public static AttributeValue allOfAll(EvaluationContext ctx, Object[] params) throws IndeterminateException {
		checkArguments(params, 3);
		AttributeValue funcId = (AttributeValue) params[0];
		AttributeValue[] bag1 = (AttributeValue[]) params[1];
		AttributeValue[] bag2 = (AttributeValue[]) params[2];
