...
public abstract class NumberFunctions {
	private static void checkArgumentNumberType(AttributeValue value) throws IndeterminateException {
		if (!(value.getValue() instanceof Number)) {
			throw new IndeterminateException(
					"Expected a number type, but got a " + value.getValue().getClass().getName());
		}
	}
	...
	@XACMLFunction({ "urn:oasis:names:tc:xacml:1.0:function:integer-add",
			"urn:oasis:names:tc:xacml:1.0:function:double-add" })
	public static AttributeValue numberAdd(EvaluationContext ctx, Object[] params) throws IndeterminateException {
	...
	@XACMLFunction({ "urn:oasis:names:tc:xacml:1.0:function:integer-subtract",
			"urn:oasis:names:tc:xacml:1.0:function:double-subtract" })
	public static AttributeValue numberSubtract(EvaluationContext ctx, Object[] params) throws IndeterminateException {
		checkArguments(params, 2);
		AttributeValue num = (AttributeValue) params[0];
	...
	@XACMLFunction({ "urn:oasis:names:tc:xacml:1.0:function:integer-multiply",
			"urn:oasis:names:tc:xacml:1.0:function:double-multiply" })
	public static AttributeValue numberMultiply(EvaluationContext ctx, Object[] params) throws IndeterminateException {
		checkArguments(params, 2);
		AttributeValue num = (AttributeValue) params[0];
	...
	@XACMLFunction({ "urn:oasis:names:tc:xacml:1.0:function:integer-divide",
			"urn:oasis:names:tc:xacml:1.0:function:double-divide" })
	public static AttributeValue numberDivide(EvaluationContext ctx, Object[] params) throws IndeterminateException {
		checkArguments(params, 2);
		AttributeValue num = (AttributeValue) params[0];
	...
	@XACMLFunction({ "urn:oasis:names:tc:xacml:1.0:function:integer-abs",
	...
	@SuppressWarnings("unchecked")
	private static int compareNumber(Object[] params) throws IndeterminateException {
		checkArguments(params, 2);
	...
	@XACMLFunction({ "urn:oasis:names:tc:xacml:1.0:function:integer-greater-than",
	...
	@XACMLFunction({ "urn:oasis:names:tc:xacml:1.0:function:integer-greater-than-or-equal",
	...
	@XACMLFunction({ "urn:oasis:names:tc:xacml:1.0:function:integer-less-than",
			"urn:oasis:names:tc:xacml:1.0:function:double-less-than" })
	public static AttributeValue numberLessThan(EvaluationContext ctx, Object[] params) throws IndeterminateException {
		return compareNumber(params) < 0 ? TRUE : FALSE;
	}

	@XACMLFunction({ "urn:oasis:names:tc:xacml:1.0:function:integer-less-than-or-equal",
	...
	public static AttributeValue integerMod(EvaluationContext ctx, Object[] params) throws IndeterminateException {
		checkArguments(params, 2);
		AttributeValue num = (AttributeValue) params[0];
		AttributeValue divisor = (AttributeValue) params[1];
