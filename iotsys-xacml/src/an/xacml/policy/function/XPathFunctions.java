...
public abstract class XPathFunctions {
	...
	public static AttributeValue nodeEqual(EvaluationContext ctx, Object[] params) throws IndeterminateException {
	...
	public static AttributeValue nodeMatch(EvaluationContext ctx, Object[] params) throws IndeterminateException {
		checkArguments(params, 2);
		AttributeValue exp1 = (AttributeValue) params[0];
		AttributeValue exp2 = (AttributeValue) params[1];
		checkArgumentType(exp1, Constants.TYPE_STRING);
		...
		try {
			...
			throw new IndeterminateException(
					"Error occurs while evaluating function nodeMatch : " + xpathExp1 + ", " + xpathExp2);
		}
	}
}