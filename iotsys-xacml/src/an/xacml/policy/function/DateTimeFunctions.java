...
public abstract class DateTimeFunctions {
	private static void checkArgumentDateType(AttributeValue attrVal) throws IndeterminateException {
		...
		if (!(actualAttr instanceof XMLGregorianCalendar)) {
			throw new IndeterminateException(
					"Expected a XMLGregorianCalendar type, but we got a " + actualAttr.getClass().getName());
		}
	}
	...
	private static void checkArgumentDurationType(AttributeValue attrVal) throws IndeterminateException {
		...
		if (!(actualAttr instanceof Duration)) {
			throw new IndeterminateException(
					"Expected a Duration type, but we got a " + actualAttr.getClass().getName());
		}
	}

	@XACMLFunction({ "urn:oasis:names:tc:xacml:1.0:function:dateTime-add-dayTimeDuration",
	...
	public static AttributeValue dateAdd(EvaluationContext ctx, Object[] params) throws IndeterminateException {
	...
	@XACMLFunction({ "urn:oasis:names:tc:xacml:1.0:function:dateTime-subtract-dayTimeDuration",
	...
	public static AttributeValue dateSubtract(EvaluationContext ctx, Object[] params) throws IndeterminateException {
		checkArguments(params, 2);
		AttributeValue date = (AttributeValue) params[0];
		AttributeValue duration = (AttributeValue) params[1];
		checkArgumentDateType(date);
	...
	@XACMLFunction({ "urn:oasis:names:tc:xacml:1.0:function:date-greater-than",
			"urn:oasis:names:tc:xacml:1.0:function:time-greater-than",
			"urn:oasis:names:tc:xacml:1.0:function:dateTime-greater-than" })
	public static AttributeValue dateGreaterThan(EvaluationContext ctx, Object[] params) throws IndeterminateException {
		return compareDate(params) > 0 ? TRUE : FALSE;
	}

	@XACMLFunction({ "urn:oasis:names:tc:xacml:1.0:function:date-greater-than-or-equal",
	...
	@XACMLFunction({ "urn:oasis:names:tc:xacml:1.0:function:date-less-than",
			"urn:oasis:names:tc:xacml:1.0:function:time-less-than",
			"urn:oasis:names:tc:xacml:1.0:function:dateTime-less-than" })
	public static AttributeValue dateLessThan(EvaluationContext ctx, Object[] params) throws IndeterminateException {
		return compareDate(params) < 0 ? TRUE : FALSE;
	}

	@XACMLFunction({ "urn:oasis:names:tc:xacml:1.0:function:date-less-than-or-equal",
	...
	public static AttributeValue timeInRange(EvaluationContext ctx, Object[] params) throws IndeterminateException {
