...
public abstract class CommonFunctions {
	public static void checkArguments(Object[] params, int expectedNumber) throws IndeterminateException {
		...
		for (Object param : params) {
			if (param != null && !(param instanceof AttributeValue) && !(param instanceof AttributeValue[])) {
				throw new IndeterminateException(
						"Expected 'AttributeValue' type, but got '" + param.getClass().getSimpleName() + "' type.");
			}
		}
	}
	...
	public static void checkArgumentType(AttributeValue attrVal, URI expectedType) throws IndeterminateException {
	...
	@EquivalentFunction
	@XACMLFunction({ "urn:oasis:names:tc:xacml:1.0:function:string-equal",
			"urn:oasis:names:tc:xacml:1.0:function:boolean-equal",
			"urn:oasis:names:tc:xacml:1.0:function:integer-equal", "urn:oasis:names:tc:xacml:1.0:function:date-equal",
			"urn:oasis:names:tc:xacml:1.0:function:time-equal", "urn:oasis:names:tc:xacml:1.0:function:dateTime-equal",
	...
	@XACMLFunction({ "urn:oasis:names:tc:xacml:1.0:function:string-one-and-only",
	...
	public static AttributeValue bagOneAndOnly(EvaluationContext ctx, Object[] params) throws IndeterminateException {
		...
		throw new IndeterminateException(
				"Expected 1 and only 1 element in bag, but we got " + (bag == null ? "'null'" : bag.length));
	}

	@XACMLFunction({ "urn:oasis:names:tc:xacml:1.0:function:string-bag-size",
	...
	public static AttributeValue bagSize(EvaluationContext ctx, Object[] params) throws IndeterminateException {
		checkArguments(params, 1);
		AttributeValue[] bag = (AttributeValue[]) params[0];
		try {
	...
	@XACMLFunction({ "urn:oasis:names:tc:xacml:1.0:function:string-is-in",
			"urn:oasis:names:tc:xacml:1.0:function:boolean-is-in",
			"urn:oasis:names:tc:xacml:1.0:function:integer-is-in", "urn:oasis:names:tc:xacml:1.0:function:double-is-in",
			"urn:oasis:names:tc:xacml:1.0:function:time-is-in", "urn:oasis:names:tc:xacml:1.0:function:date-is-in",
	...
	public static AttributeValue bagIsIn(EvaluationContext ctx, Object[] params) throws IndeterminateException {
		checkArguments(params, 2);
		checkNull(params);
	...
	@XACMLFunction({ "urn:oasis:names:tc:xacml:1.0:function:string-bag",
			"urn:oasis:names:tc:xacml:1.0:function:boolean-bag", "urn:oasis:names:tc:xacml:1.0:function:integer-bag",
			"urn:oasis:names:tc:xacml:1.0:function:double-bag", "urn:oasis:names:tc:xacml:1.0:function:time-bag",
			"urn:oasis:names:tc:xacml:1.0:function:date-bag", "urn:oasis:names:tc:xacml:1.0:function:dateTime-bag",
			"urn:oasis:names:tc:xacml:1.0:function:anyURI-bag", "urn:oasis:names:tc:xacml:1.0:function:hexBinary-bag",
	...
	public static AttributeValue[] bagBag(EvaluationContext ctx, Object[] params) throws IndeterminateException {
		for (Object param : params) {
	...
	@XACMLFunction({ "urn:oasis:names:tc:xacml:1.0:function:string-intersection",
	...
	@XACMLFunction({ "urn:oasis:names:tc:xacml:1.0:function:string-at-least-one-member-of",
	...
	@XACMLFunction({ "urn:oasis:names:tc:xacml:1.0:function:string-union",
			"urn:oasis:names:tc:xacml:1.0:function:boolean-union",
			"urn:oasis:names:tc:xacml:1.0:function:integer-union", "urn:oasis:names:tc:xacml:1.0:function:double-union",
			"urn:oasis:names:tc:xacml:1.0:function:time-union", "urn:oasis:names:tc:xacml:1.0:function:date-union",
	...
	public static AttributeValue[] setUnion(EvaluationContext ctx, Object[] params) throws IndeterminateException {
		checkArguments(params, 2);
		AttributeValue[] bag1 = (AttributeValue[]) params[0];
		AttributeValue[] bag2 = (AttributeValue[]) params[0];
	...
	@XACMLFunction({ "urn:oasis:names:tc:xacml:1.0:function:string-subset",
			"urn:oasis:names:tc:xacml:1.0:function:boolean-subset",
			"urn:oasis:names:tc:xacml:1.0:function:integer-subset",
			"urn:oasis:names:tc:xacml:1.0:function:double-subset", "urn:oasis:names:tc:xacml:1.0:function:time-subset",
	...
	public static AttributeValue setSubset(EvaluationContext ctx, Object[] params) throws IndeterminateException {
		checkArguments(params, 2);
		AttributeValue[] bag1 = (AttributeValue[]) params[0];
		AttributeValue[] bag2 = (AttributeValue[]) params[0];
	...
	@EquivalentFunction
	@XACMLFunction({ "urn:oasis:names:tc:xacml:1.0:function:string-set-equals",
	...
	public static AttributeValue setEquals(EvaluationContext ctx, Object[] params) throws IndeterminateException {
		checkArguments(params, 2);
		AttributeValue[] bag1 = (AttributeValue[]) params[0];
		AttributeValue[] bag2 = (AttributeValue[]) params[0];
