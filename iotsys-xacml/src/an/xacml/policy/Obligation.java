...
public class Obligation extends DefaultXACMLElement {
	...
	/**
	 * A copy constructor which is used to create a new Obligation instance from
	 * an existing one.
	 * 
	 * @param obl
	 */
	...
	public boolean equals(Object o) {
		...
		if (o != null && o.getClass() == this.getClass()) {
			...
			if (compareObject(this.obligationId, other.obligationId) && compareObject(this.fulfillOn, other.fulfillOn)
