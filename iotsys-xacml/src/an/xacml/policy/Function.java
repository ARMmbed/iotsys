...
public class Function extends DefaultXACMLElement implements Expression {
	...
	/**
	 * We only need return a function id to parent element, parent element will
	 * evaluate the rest elements and use the result as parameters of the
	 * built-in function, and then evaluate the built-in function.
	 */
