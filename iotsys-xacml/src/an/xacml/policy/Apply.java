...
public class Apply extends DefaultXACMLElement implements Expression {
	...
	public Object evaluate(EvaluationContext ctx) throws IndeterminateException {
		try {
			...
			// If function is logical function, we won't evaluate the
			// expression, we let function itself to evaluate
			...
			try {
				...
				// All indeterminate exception throws from function should be
				// processing error, ...
