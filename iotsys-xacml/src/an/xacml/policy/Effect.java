...
/**
 * Represent the Effect element of XACML. It provides an equals method that can
 * be compared to EvaluationResult.
 */
public enum Effect implements XACMLElement {
	...
	public boolean equals(Decision decision) {
		if (decision != null
				&& ((decision == Decision.Permit && this == Permit) || (decision == Decision.Deny && this == Deny))) {
			return true;
		}
		return false;
	}
