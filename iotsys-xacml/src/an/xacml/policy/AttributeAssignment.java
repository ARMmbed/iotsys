...
public class AttributeAssignment extends AttributeValue {
	...
	/**
	 * A copy constructor which is used to create a new AttributeAssignment
	...
	public AttributeAssignment(AttributeAssignment attrAssig) throws XMLDataTypeMappingException {
		// Since all feilds of AttributeValue are constants, we don't need copy
		// them, just use them in new instance.
	...
	/**
	 * This is an unnormal method, it will modify the internal fields' value.
	 * Once the AttributeAssignment instance is evaluated, its value is fixed,
	 * and its child expression is set to null.
	 */
