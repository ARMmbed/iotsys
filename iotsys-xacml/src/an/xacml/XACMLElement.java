...
public interface XACMLElement {
	...
	/**
	 * Each engine element instance may have a name, but it is not required. One
	 * who want to use it should first set it.
	 * 
	 * @return
	 */
	...
	/**
	 * Return the root XACML element. The root element should be a Policy or
	 * PolicySet element.
	 * 
	 * @return
	 */
