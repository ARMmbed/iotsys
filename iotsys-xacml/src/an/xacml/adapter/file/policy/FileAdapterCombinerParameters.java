...
public class FileAdapterCombinerParameters extends AbstractFileAdapterPolicyElement {
	/**
	 * <xs:element name="CombinerParameters" type=
	 * "xacml:CombinerParametersType"/>
	 * <xs:complexType name="CombinerParametersType"> <xs:sequence>
	 * <xs:element ref="xacml:CombinerParameter" minOccurs="0" maxOccurs=
