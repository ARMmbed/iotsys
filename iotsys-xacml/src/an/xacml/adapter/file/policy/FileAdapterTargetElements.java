...
public abstract class FileAdapterTargetElements extends AbstractFileAdapterPolicyElement {
	 ...
	 * <xs:complexType name="SubjectsType"> <xs:sequence>
	 * <xs:element ref="xacml:Subject" maxOccurs="unbounded"/> </xs:sequence>
	 * </xs:complexType>
	 * 
	 * <xs:element name="Resources" type="xacml:ResourcesType"/>
	 * <xs:complexType name="ResourcesType"> <xs:sequence>
	 * <xs:element ref="xacml:Resource" maxOccurs="unbounded"/> </xs:sequence>
	 * </xs:complexType>
	 * 
	 * <xs:element name="Actions" type="xacml:ActionsType"/>
	 * <xs:complexType name="ActionsType"> <xs:sequence>
	 * <xs:element ref="xacml:Action" maxOccurs="unbounded"/> </xs:sequence>
	 * </xs:complexType>
	 * 
	 * <xs:element name="Environments" type="xacml:EnvironmentsType"/>
	 * <xs:complexType name="EnvironmentsType"> <xs:sequence>
	...
	protected void initializeTargetElement(XACMLElement engineElem) throws Exception {
		...
		for (int i = 0; i < matches.length; i++) {
			// Retrieve the corresponding DataAdapter class, then create an
			// instance
