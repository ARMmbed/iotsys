...
public class FileAdapterIdReference extends AbstractFileAdapterPolicyElement {
	/**
	 * <xs:complexType name="IdReferenceType"> <xs:simpleContent>
	 * <xs:extension base="xs:anyURI">
	 * <xs:attribute name="Version" type="xacml:VersionMatchType" use=
	 * "optional"/>
	 * <xs:attribute name="EarliestVersion" type="xacml:VersionMatchType" use=
	 * "optional"/>
	 * <xs:attribute name="LatestVersion" type="xacml:VersionMatchType" use=
	...
	public FileAdapterIdReference(Element elem)
			throws PolicySyntaxException, XMLGeneralException, DOMException, URISyntaxException {
