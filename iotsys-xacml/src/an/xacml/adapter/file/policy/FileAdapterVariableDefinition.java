...
public class FileAdapterVariableDefinition extends AbstractFileAdapterPolicyElement {
	/**
	 * <xs:element name="VariableDefinition" type=
	 * "xacml:VariableDefinitionType"/>
	 * <xs:complexType name="VariableDefinitionType"> <xs:sequence>
	 * <xs:element ref="xacml:Expression"/> </xs:sequence>
	...
	public FileAdapterVariableDefinition(Element elem) throws PolicySyntaxException {
		...
		if (children.length == 1) {
			...
			throw new PolicySyntaxException(
					"Expected 1 expression element inside VariableDefinition, but we got " + children.length);
		}
	}
