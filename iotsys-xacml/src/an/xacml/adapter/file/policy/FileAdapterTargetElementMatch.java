...
public abstract class FileAdapterTargetElementMatch extends AbstractFileAdapterPolicyElement {
	 ...
	 * <xs:complexType name="ActionMatchType"> <xs:sequence>
	 * <xs:element ref="xacml:AttributeValue"/> <xs:choice>
	 * <xs:element ref="xacml:ActionAttributeDesignator"/>
	 * <xs:element ref="xacml:AttributeSelector"/> </xs:choice> </xs:sequence>
	 * <xs:attribute name="MatchId" type="xs:anyURI" use="required"/>
	 * </xs:complexType>
	 * 
	 * <xs:element name="EnvironmentMatch" type="xacml:EnvironmentMatchType"/>
	 * <xs:complexType name="EnvironmentMatchType"> <xs:sequence>
	 * <xs:element ref="xacml:AttributeValue"/> <xs:choice>
	 ...
	 * <xs:complexType name="ResourceMatchType"> <xs:sequence>
	 * <xs:element ref="xacml:AttributeValue"/> <xs:choice>
	 ...
	 * <xs:complexType name="SubjectMatchType"> <xs:sequence>
	 * <xs:element ref="xacml:AttributeValue"/> <xs:choice>
	...
	protected void initializeTargetElement(Element elem, Class<?> engineClass) throws Exception {
		...
		Constructor<?> matchCons = engineClass
				.getConstructor(new Class[] { URI.class, AttributeValue.class, Expression.class });
		engineElem = (XACMLElement) matchCons.newInstance(matchId, ((DataAdapter) attrValue).getEngineElement(),
				((DataAdapter) designatorOrSelector).getEngineElement());
