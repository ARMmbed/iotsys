...
public class FileAdapterApply extends FileAdapterExpression {
	/**
	 * <xs:element name="Apply" type="xacml:ApplyType" substitutionGroup=
	 * "xacml:Expression"/> <xs:complexType name="ApplyType">
	 * <xs:complexContent> <xs:extension base="xacml:ExpressionType">
	 * <xs:sequence>
