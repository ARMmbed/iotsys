...
/**
 * This class represents an text element such as the text node of
 * AttributeValue. Note, even this class is derived from
 * AbstractFileAdapterElement, but it doesn't implement DataAdapter interface.
 * Users should not use it as a DataAdapter.
 */
