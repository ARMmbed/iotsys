...
/**
 * A factory class that used to create Request from context, create response
 * context from Response, and create ContextHandler.
 */
public interface ContextFactory {
	...
	/**
	 * Get a ContextHandler object. The ContextHandler controls the engine's
	 * process flow.
	 * 
	 * @return
	 */
