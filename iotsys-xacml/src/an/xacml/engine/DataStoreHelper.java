...
/**
 * If "an.xacml.engine.DataStore" is configured for a custom DataStore in
 * configuration file or in VM argument, the helper will create an instance of
 * the configured one. The custom PolicyLoader should implements PolicyLoader
...
public abstract class DataStoreHelper {
	 ...
	 * policy loader should implement interface PolicyLoader, and its
