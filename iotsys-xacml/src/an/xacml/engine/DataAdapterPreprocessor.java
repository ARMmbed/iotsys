...
/**
 * This class is used to preprocess data adapters that loaded from underlying
 * data store. Currently it in charge of populate policies to IdReference
 * element. It may be added other processes in the future.
 */
