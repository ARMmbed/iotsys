...
/**
 * The "urn:oasis:names:tc:xacml:2.0:data-type:dnsName" primitive type
 * represents a Domain Name Service (DNS) host name, with optional port or port
 * range. The syntax SHALL be:
 * 
 * dnsName = hostname [ ":" portrange ]
 * 
 * The hostname is formatted in accordance with IETF RFC 2396 "Uniform Resource
 * Identifiers (URI): Generic Syntax", section 3.2, except that a wildcard "*"
 * may be used in the left-most component of the hostname to indicate "any
 * subdomain" under the domain specified to its right.
 */
