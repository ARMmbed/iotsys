...
public class DPT_16_ImplKnx extends DPT_16_Impl {
	...
	public DPT_16_ImplKnx(KNXConnector connector, GroupAddress groupAddress, String name, String displayName,
		...
		connector.addWatchDog(groupAddress, new KNXWatchDog() {
			...
			public void notifyWatchDog(byte[] apdu) {
				try {
					...
					// first set null to false, since the set on the instance
