...
public class KNXDeviceLoaderETSImplGenerated implements DeviceLoader {
	...
	public ArrayList<Connector> initDevices(ObjectBroker objectBroker) {
		KNXConnector knxConnector = new KNXConnector("192.168.1.102", 3671, "auto");
	...
	private void initAddresses(HashMap<String, Integer> groupAddresses) {
		...
		groupAddresses.put("P-0341-0_DI-3_M-0001_A-9803-03-3F77_O-3_R-4", currentAddress);

		groupAddresses.put("P-0341-0_DI-10_M-0001_A-2413-01-B14F_O-4_R-27", currentAddress);

		currentAddress = 2049;

		groupAddresses.put("P-0341-0_DI-2_M-0001_A-6102-01-A218_O-1_R-1", currentAddress);

		groupAddresses.put("P-0341-0_DI-10_M-0001_A-2413-01-B14F_O-7_R-41", currentAddress);

		currentAddress = 2050;

		groupAddresses.put("P-0341-0_DI-2_M-0001_A-6102-01-A218_O-0_R-0", currentAddress);

		groupAddresses.put("P-0341-0_DI-10_M-0001_A-2413-01-B14F_O-6_R-38", currentAddress);

		currentAddress = 2051;

		groupAddresses.put("P-0341-0_DI-2_M-0001_A-6102-01-A218_O-3_R-3", currentAddress);

		currentAddress = 2304;

		currentAddress = 2304;

		groupAddresses.put("P-0341-0_DI-11_M-0001_A-9814-01-5F7E_O-0_R-2", currentAddress);

		currentAddress = 2305;

		groupAddresses.put("P-0341-0_DI-11_M-0001_A-9814-01-5F7E_O-1_R-3", currentAddress);

		currentAddress = 2306;

		groupAddresses.put("P-0341-0_DI-11_M-0001_A-9814-01-5F7E_O-2_R-1", currentAddress);

		currentAddress = 2307;

		groupAddresses.put("P-0341-0_DI-11_M-0001_A-9814-01-5F7E_O-3_R-4", currentAddress);

		currentAddress = 2816;

		currentAddress = 2817;

		groupAddresses.put("P-0341-0_DI-7_M-0064_A-FF21-11-DDFC-O0048_O-0_R-1", currentAddress);

		currentAddress = 2818;

		groupAddresses.put("P-0341-0_DI-7_M-0064_A-FF21-11-DDFC-O0048_O-1_R-2", currentAddress);

		currentAddress = 2819;

		groupAddresses.put("P-0341-0_DI-7_M-0064_A-FF21-11-DDFC-O0048_O-3_R-50", currentAddress);

		currentAddress = 2820;

		groupAddresses.put("P-0341-0_DI-7_M-0064_A-FF21-11-DDFC-O0048_O-5_R-55", currentAddress);

		currentAddress = 2821;

		groupAddresses.put("P-0341-0_DI-7_M-0064_A-FF21-11-DDFC-O0048_O-7_R-60", currentAddress);

		currentAddress = 3072;

		currentAddress = 3072;

		groupAddresses.put("P-0341-0_DI-10_M-0001_A-2413-01-B14F_O-0_R-10", currentAddress);

		currentAddress = 3073;

		groupAddresses.put("P-0341-0_DI-10_M-0001_A-2413-01-B14F_O-2_R-18", currentAddress);
	...
	private void initTranslations(HashMap<String, ArrayList<ArrayList<String>>> translations) {
		...
		try {
			...
			if (translations.containsKey("P-0341")) {
				for (ArrayList<String> entry : translations.get("P-0341")) {
					_13950516787910.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("standard")) {
				for (ArrayList<String> entry : translations.get("standard")) {
					_13950516787991.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("datapoints")) {
				for (ArrayList<String> entry : translations.get("datapoints")) {
					_13950516787992.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("entities")) {
				for (ArrayList<String> entry : translations.get("entities")) {
					_13950516788003.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("functional")) {
				for (ArrayList<String> entry : translations.get("functional")) {
					_13950516788004.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("topology")) {
				for (ArrayList<String> entry : translations.get("topology")) {
					_13950516788015.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("building")) {
				for (ArrayList<String> entry : translations.get("building")) {
					_13950516788016.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("domains")) {
				for (ArrayList<String> entry : translations.get("domains")) {
					_13950516788017.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("datapoints")) {
				for (ArrayList<String> entry : translations.get("datapoints")) {
					_13950516788018.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			// init object
			_13950516788029.setName("P-0341-0_DI-2_M-0001_A-6102-01-A218_O-1_R-1");
			...
			// add existing translations
			if (translations.containsKey("P-0341-0_DI-2_M-0001_A-6102-01-A218_O-1_R-1")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_DI-2_M-0001_A-6102-01-A218_O-1_R-1")) {
					_13950516788029.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			// init object
			_139505167880210.setName("P-0341-0_DI-2_M-0001_A-6102-01-A218_O-3_R-3");
			...
			// add existing translations
			if (translations.containsKey("P-0341-0_DI-2_M-0001_A-6102-01-A218_O-3_R-3")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_DI-2_M-0001_A-6102-01-A218_O-3_R-3")) {
					_139505167880210.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			// init object
			_139505167880211.setName("P-0341-0_DI-2_M-0001_A-6102-01-A218_O-0_R-0");
			...
			// add existing translations
			if (translations.containsKey("P-0341-0_DI-2_M-0001_A-6102-01-A218_O-0_R-0")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_DI-2_M-0001_A-6102-01-A218_O-0_R-0")) {
					_139505167880211.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			// init object
			_139505167880312.setName("P-0341-0_DI-3_M-0001_A-9803-03-3F77_O-3_R-4");
			...
			// add existing translations
			if (translations.containsKey("P-0341-0_DI-3_M-0001_A-9803-03-3F77_O-3_R-4")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_DI-3_M-0001_A-9803-03-3F77_O-3_R-4")) {
					_139505167880312.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			// init object
			_139505167880313.setName("P-0341-0_DI-11_M-0001_A-9814-01-5F7E_O-0_R-2");
			...
			// add existing translations
			if (translations.containsKey("P-0341-0_DI-11_M-0001_A-9814-01-5F7E_O-0_R-2")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_DI-11_M-0001_A-9814-01-5F7E_O-0_R-2")) {
					_139505167880313.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			// init object
			_139505167880314.setName("P-0341-0_DI-11_M-0001_A-9814-01-5F7E_O-1_R-3");
			...
			// add existing translations
			if (translations.containsKey("P-0341-0_DI-11_M-0001_A-9814-01-5F7E_O-1_R-3")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_DI-11_M-0001_A-9814-01-5F7E_O-1_R-3")) {
					_139505167880314.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			// init object
			_139505167880415.setName("P-0341-0_DI-11_M-0001_A-9814-01-5F7E_O-2_R-1");
			...
			// add existing translations
			if (translations.containsKey("P-0341-0_DI-11_M-0001_A-9814-01-5F7E_O-2_R-1")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_DI-11_M-0001_A-9814-01-5F7E_O-2_R-1")) {
					_139505167880415.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			// init object
			_139505167880416.setName("P-0341-0_DI-11_M-0001_A-9814-01-5F7E_O-3_R-4");
			...
			// add existing translations
			if (translations.containsKey("P-0341-0_DI-11_M-0001_A-9814-01-5F7E_O-3_R-4")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_DI-11_M-0001_A-9814-01-5F7E_O-3_R-4")) {
					_139505167880416.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			// init object
			_139505167880517.setName("P-0341-0_DI-7_M-0064_A-FF21-11-DDFC-O0048_O-3_R-50");
			...
			// add existing translations
			if (translations.containsKey("P-0341-0_DI-7_M-0064_A-FF21-11-DDFC-O0048_O-3_R-50")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_DI-7_M-0064_A-FF21-11-DDFC-O0048_O-3_R-50")) {
					_139505167880517.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			// init object
			_139505167880518.setName("P-0341-0_DI-7_M-0064_A-FF21-11-DDFC-O0048_O-5_R-55");
			...
			// add existing translations
			if (translations.containsKey("P-0341-0_DI-7_M-0064_A-FF21-11-DDFC-O0048_O-5_R-55")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_DI-7_M-0064_A-FF21-11-DDFC-O0048_O-5_R-55")) {
					_139505167880518.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			// init object
			_139505167880519.setName("P-0341-0_DI-7_M-0064_A-FF21-11-DDFC-O0048_O-7_R-60");
			...
			// add existing translations
			if (translations.containsKey("P-0341-0_DI-7_M-0064_A-FF21-11-DDFC-O0048_O-7_R-60")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_DI-7_M-0064_A-FF21-11-DDFC-O0048_O-7_R-60")) {
					_139505167880519.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			// init object
			_139505167880620.setName("P-0341-0_DI-7_M-0064_A-FF21-11-DDFC-O0048_O-0_R-1");
			...
			// add existing translations
			if (translations.containsKey("P-0341-0_DI-7_M-0064_A-FF21-11-DDFC-O0048_O-0_R-1")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_DI-7_M-0064_A-FF21-11-DDFC-O0048_O-0_R-1")) {
					_139505167880620.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			// init object
			_139505167880721.setName("P-0341-0_DI-7_M-0064_A-FF21-11-DDFC-O0048_O-1_R-2");
			...
			// add existing translations
			if (translations.containsKey("P-0341-0_DI-7_M-0064_A-FF21-11-DDFC-O0048_O-1_R-2")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_DI-7_M-0064_A-FF21-11-DDFC-O0048_O-1_R-2")) {
					_139505167880721.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			// init object
			_139505167880822.setName("P-0341-0_DI-10_M-0001_A-2413-01-B14F_O-0_R-10");
			...
			// add existing translations
			if (translations.containsKey("P-0341-0_DI-10_M-0001_A-2413-01-B14F_O-0_R-10")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_DI-10_M-0001_A-2413-01-B14F_O-0_R-10")) {
					_139505167880822.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			// init object
			_139505167880823.setName("P-0341-0_DI-10_M-0001_A-2413-01-B14F_O-2_R-18");
			...
			// add existing translations
			if (translations.containsKey("P-0341-0_DI-10_M-0001_A-2413-01-B14F_O-2_R-18")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_DI-10_M-0001_A-2413-01-B14F_O-2_R-18")) {
					_139505167880823.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			// init object
			_139505167880824.setName("P-0341-0_DI-10_M-0001_A-2413-01-B14F_O-7_R-41");
			...
			// add existing translations
			if (translations.containsKey("P-0341-0_DI-10_M-0001_A-2413-01-B14F_O-7_R-41")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_DI-10_M-0001_A-2413-01-B14F_O-7_R-41")) {
					_139505167880824.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			// init object
			_139505167880825.setName("P-0341-0_DI-10_M-0001_A-2413-01-B14F_O-6_R-38");
			...
			// add existing translations
			if (translations.containsKey("P-0341-0_DI-10_M-0001_A-2413-01-B14F_O-6_R-38")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_DI-10_M-0001_A-2413-01-B14F_O-6_R-38")) {
					_139505167880825.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			// init object
			_139505167880926.setName("P-0341-0_DI-10_M-0001_A-2413-01-B14F_O-4_R-27");
			...
			// add existing translations
			if (translations.containsKey("P-0341-0_DI-10_M-0001_A-2413-01-B14F_O-4_R-27")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_DI-10_M-0001_A-2413-01-B14F_O-4_R-27")) {
					_139505167880926.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("entities")) {
				for (ArrayList<String> entry : translations.get("entities")) {
					_139505167880927.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			// add existing translations
			if (translations.containsKey("P-0341-0_DI-1")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_DI-1")) {
					_139505167880928.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			// add existing translations
			if (translations.containsKey("P-0341-0_DI-2")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_DI-2")) {
					_139505167881029.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			_139505167881030.setDisplayName("Switching actuator N 567/01, (8 Amp)");

			_139505167881030.setIs(new Contract("bas:Entity"));

			// add existing translations
			if (translations.containsKey("P-0341-0_DI-3")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_DI-3")) {
					_139505167881030.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}

			// set uri
			_139505167881030.setHref(new Uri("switching_actuator_n_567_01_8_amp/1"));
			...
			// add existing translations
			if (translations.containsKey("P-0341-0_DI-11")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_DI-11")) {
					_139505167881031.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			_139505167881132.setDisplayName("Push button 2-fold UP 211 DELTA studio (red lens)");

			_139505167881132.setIs(new Contract("bas:Entity"));

			// add existing translations
			if (translations.containsKey("P-0341-0_DI-9")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_DI-9")) {
					_139505167881132.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}

			// set uri
			_139505167881132.setHref(new Uri("push_button_2_fold_up_211_delta_studio_red_lens/1"));
			...
			_139505167881133.setDisplayName("KNX CO², Humidity and Temperature Sensor");

			_139505167881133.setIs(new Contract("bas:Entity"));

			// add existing translations
			if (translations.containsKey("P-0341-0_DI-7")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_DI-7")) {
					_139505167881133.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}

			// set uri
			_139505167881133.setHref(new Uri("knx_co2_humidity_and_temperature_sensor/1"));
			...
			_139505167881134.setDisplayName("Push button 4-f UP 245 DELTA profil (without sym)");

			_139505167881134.setIs(new Contract("bas:Entity"));

			// add existing translations
			if (translations.containsKey("P-0341-0_DI-10")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_DI-10")) {
					_139505167881134.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}

			// set uri
			_139505167881134.setHref(new Uri("push_button_4_f_up_245_delta_profil_without_sym/1"));
			...
			if (translations.containsKey("functional")) {
				for (ArrayList<String> entry : translations.get("functional")) {
					_139505167881235.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("groups")) {
				for (ArrayList<String> entry : translations.get("groups")) {
					_139505167881236.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("P-0341-0_GR-1")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_GR-1")) {
					_139505167881237.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("address")) {
				for (ArrayList<String> entry : translations.get("address")) {
					_139505167881238.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("groups")) {
				for (ArrayList<String> entry : translations.get("groups")) {
					_139505167881339.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("P-0341-0_GR-4")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_GR-4")) {
					_139505167881340.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("address")) {
				for (ArrayList<String> entry : translations.get("address")) {
					_139505167881341.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("P-0341-0_GR-2")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_GR-2")) {
					_139505167881442.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("address")) {
				for (ArrayList<String> entry : translations.get("address")) {
					_139505167881443.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("groups")) {
				for (ArrayList<String> entry : translations.get("groups")) {
					_139505167881444.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("P-0341-0_GA-1")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_GA-1")) {
					_139505167881445.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("address")) {
				for (ArrayList<String> entry : translations.get("address")) {
					_139505167881546.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("function")) {
				for (ArrayList<String> entry : translations.get("function")) {
					_139505167881547.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}

			// set uri
			_139505167881547.setHref(new Uri("/networks/office/datapoints/switch_channel_a/1"));
			...
			if (translations.containsKey("instances")) {
				for (ArrayList<String> entry : translations.get("instances")) {
					_139505167881548.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			// init object
			_139505167881549.setName("P-0341-0_DI-3_M-0001_A-9803-03-3F77_O-3_R-4");
			...
			if (translations.containsKey("P-0341-0_DI-3_M-0001_A-9803-03-3F77_O-3_R-4")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_DI-3_M-0001_A-9803-03-3F77_O-3_R-4")) {
					_139505167881549.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("connector")) {
				for (ArrayList<String> entry : translations.get("connector")) {
					_139505167881650.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			_139505167881651.setIs(new Contract("bas:Datapoint bas:DPST-1-1 bas:DPT-1 bas:Datapoint"));

			// add existing translations
			if (translations.containsKey("reference")) {
				for (ArrayList<String> entry : translations.get("reference")) {
					_139505167881651.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}

			// set uri
			_139505167881651.setHref(new Uri("/networks/office/datapoints/switch_channel_a/1"));
			...
			// init object
			_139505167881652.setName("P-0341-0_DI-10_M-0001_A-2413-01-B14F_O-4_R-27");
			...
			if (translations.containsKey("P-0341-0_DI-10_M-0001_A-2413-01-B14F_O-4_R-27")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_DI-10_M-0001_A-2413-01-B14F_O-4_R-27")) {
					_139505167881652.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("connector")) {
				for (ArrayList<String> entry : translations.get("connector")) {
					_139505167881653.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			_139505167881754.setIs(new Contract("bas:Datapoint bas:DPST-1-1 bas:DPT-1 bas:Datapoint"));

			// add existing translations
			if (translations.containsKey("reference")) {
				for (ArrayList<String> entry : translations.get("reference")) {
					_139505167881754.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}

			// set uri
			_139505167881754.setHref(new Uri("/networks/office/datapoints/switch_centre_right/1"));
			...
			if (translations.containsKey("P-0341-0_GA-2")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_GA-2")) {
					_139505167881755.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("address")) {
				for (ArrayList<String> entry : translations.get("address")) {
					_139505167881756.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("function")) {
				for (ArrayList<String> entry : translations.get("function")) {
					_139505167881757.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}

			// set uri
			_139505167881757.setHref(new Uri("/networks/office/datapoints/dimming/1"));
			...
			if (translations.containsKey("instances")) {
				for (ArrayList<String> entry : translations.get("instances")) {
					_139505167881858.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			// init object
			_139505167881859.setName("P-0341-0_DI-2_M-0001_A-6102-01-A218_O-1_R-1");
			...
			if (translations.containsKey("P-0341-0_DI-2_M-0001_A-6102-01-A218_O-1_R-1")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_DI-2_M-0001_A-6102-01-A218_O-1_R-1")) {
					_139505167881859.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("connector")) {
				for (ArrayList<String> entry : translations.get("connector")) {
					_139505167881860.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			_139505167881861.setIs(new Contract("bas:Datapoint bas:DPST-3-7 bas:DPT-3 bas:Datapoint"));

			// add existing translations
			if (translations.containsKey("reference")) {
				for (ArrayList<String> entry : translations.get("reference")) {
					_139505167881861.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}

			// set uri
			_139505167881861.setHref(new Uri("/networks/office/datapoints/dimming/1"));
			...
			// init object
			_139505167881962.setName("P-0341-0_DI-10_M-0001_A-2413-01-B14F_O-7_R-41");
			...
			if (translations.containsKey("P-0341-0_DI-10_M-0001_A-2413-01-B14F_O-7_R-41")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_DI-10_M-0001_A-2413-01-B14F_O-7_R-41")) {
					_139505167881962.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("connector")) {
				for (ArrayList<String> entry : translations.get("connector")) {
					_139505167881963.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			_139505167881964.setIs(new Contract("bas:Datapoint bas:DPST-3-7 bas:DPT-3 bas:Datapoint"));

			// add existing translations
			if (translations.containsKey("reference")) {
				for (ArrayList<String> entry : translations.get("reference")) {
					_139505167881964.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}

			// set uri
			_139505167881964.setHref(new Uri("/networks/office/datapoints/dimming_outer_right/1"));
			...
			if (translations.containsKey("P-0341-0_GA-13")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_GA-13")) {
					_139505167881965.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("address")) {
				for (ArrayList<String> entry : translations.get("address")) {
					_139505167882066.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("function")) {
				for (ArrayList<String> entry : translations.get("function")) {
					_139505167882067.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}

			// set uri
			_139505167882067.setHref(new Uri("/networks/office/datapoints/switch_status/1"));
			...
			if (translations.containsKey("instances")) {
				for (ArrayList<String> entry : translations.get("instances")) {
					_139505167882068.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			// init object
			_139505167882069.setName("P-0341-0_DI-2_M-0001_A-6102-01-A218_O-0_R-0");
			...
			if (translations.containsKey("P-0341-0_DI-2_M-0001_A-6102-01-A218_O-0_R-0")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_DI-2_M-0001_A-6102-01-A218_O-0_R-0")) {
					_139505167882069.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("connector")) {
				for (ArrayList<String> entry : translations.get("connector")) {
					_139505167882170.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			_139505167882171.setIs(new Contract("bas:Datapoint bas:DPST-1-1 bas:DPT-1 bas:Datapoint"));

			// add existing translations
			if (translations.containsKey("reference")) {
				for (ArrayList<String> entry : translations.get("reference")) {
					_139505167882171.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}

			// set uri
			_139505167882171.setHref(new Uri("/networks/office/datapoints/switch_status/1"));
			...
			// init object
			_139505167882172.setName("P-0341-0_DI-10_M-0001_A-2413-01-B14F_O-6_R-38");
			...
			if (translations.containsKey("P-0341-0_DI-10_M-0001_A-2413-01-B14F_O-6_R-38")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_DI-10_M-0001_A-2413-01-B14F_O-6_R-38")) {
					_139505167882172.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("connector")) {
				for (ArrayList<String> entry : translations.get("connector")) {
					_139505167882173.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			_139505167882274.setIs(new Contract("bas:Datapoint bas:DPST-1-1 bas:DPT-1 bas:Datapoint"));

			// add existing translations
			if (translations.containsKey("reference")) {
				for (ArrayList<String> entry : translations.get("reference")) {
					_139505167882274.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}

			// set uri
			_139505167882274.setHref(new Uri("/networks/office/datapoints/dimming_on_off_outer_right/1"));
			...
			if (translations.containsKey("P-0341-0_GA-14")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_GA-14")) {
					_139505167882275.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("address")) {
				for (ArrayList<String> entry : translations.get("address")) {
					_139505167882276.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("function")) {
				for (ArrayList<String> entry : translations.get("function")) {
					_139505167882277.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}

			// set uri
			_139505167882277.setHref(new Uri("/networks/office/datapoints/status/1"));
			...
			if (translations.containsKey("instances")) {
				for (ArrayList<String> entry : translations.get("instances")) {
					_139505167882378.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			// init object
			_139505167882379.setName("P-0341-0_DI-2_M-0001_A-6102-01-A218_O-3_R-3");
			...
			if (translations.containsKey("P-0341-0_DI-2_M-0001_A-6102-01-A218_O-3_R-3")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_DI-2_M-0001_A-6102-01-A218_O-3_R-3")) {
					_139505167882379.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("connector")) {
				for (ArrayList<String> entry : translations.get("connector")) {
					_139505167882380.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			_139505167882381.setIs(new Contract("bas:Datapoint bas:DPST-5-1 bas:DPT-5-A bas:Datapoint"));

			// add existing translations
			if (translations.containsKey("reference")) {
				for (ArrayList<String> entry : translations.get("reference")) {
					_139505167882381.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}

			// set uri
			_139505167882381.setHref(new Uri("/networks/office/datapoints/status/1"));
			...
			_139505167882382.setDisplay("Contains groups for temperature reading	");

			_139505167882382.setIs(new Contract("bas:Group"));

			// add existing translations
			if (translations.containsKey("P-0341-0_GR-3")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_GR-3")) {
					_139505167882382.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("address")) {
				for (ArrayList<String> entry : translations.get("address")) {
					_139505167882483.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("groups")) {
				for (ArrayList<String> entry : translations.get("groups")) {
					_139505167882484.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("P-0341-0_GA-3")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_GA-3")) {
					_139505167882485.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("address")) {
				for (ArrayList<String> entry : translations.get("address")) {
					_139505167882486.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("function")) {
				for (ArrayList<String> entry : translations.get("function")) {
					_139505167882587.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}

			// set uri
			_139505167882587.setHref(new Uri("/networks/office/datapoints/temperature_channel_a/1"));
			...
			if (translations.containsKey("instances")) {
				for (ArrayList<String> entry : translations.get("instances")) {
					_139505167882588.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			// init object
			_139505167882589.setName("P-0341-0_DI-11_M-0001_A-9814-01-5F7E_O-0_R-2");
			...
			if (translations.containsKey("P-0341-0_DI-11_M-0001_A-9814-01-5F7E_O-0_R-2")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_DI-11_M-0001_A-9814-01-5F7E_O-0_R-2")) {
					_139505167882589.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("connector")) {
				for (ArrayList<String> entry : translations.get("connector")) {
					_139505167882690.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			_139505167882691.setIs(new Contract("bas:Datapoint bas:DPST-9-1 bas:DPT-9 bas:Datapoint"));

			// add existing translations
			if (translations.containsKey("reference")) {
				for (ArrayList<String> entry : translations.get("reference")) {
					_139505167882691.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}

			// set uri
			_139505167882691.setHref(new Uri("/networks/office/datapoints/temperature_channel_a/1"));
			...
			if (translations.containsKey("P-0341-0_GA-4")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_GA-4")) {
					_139505167882692.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("address")) {
				for (ArrayList<String> entry : translations.get("address")) {
					_139505167882793.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("function")) {
				for (ArrayList<String> entry : translations.get("function")) {
					_139505167882794.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}

			// set uri
			_139505167882794.setHref(new Uri("/networks/office/datapoints/temperature_channel_b/1"));
			...
			if (translations.containsKey("instances")) {
				for (ArrayList<String> entry : translations.get("instances")) {
					_139505167882795.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			// init object
			_139505167882796.setName("P-0341-0_DI-11_M-0001_A-9814-01-5F7E_O-1_R-3");
			...
			if (translations.containsKey("P-0341-0_DI-11_M-0001_A-9814-01-5F7E_O-1_R-3")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_DI-11_M-0001_A-9814-01-5F7E_O-1_R-3")) {
					_139505167882796.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("connector")) {
				for (ArrayList<String> entry : translations.get("connector")) {
					_139505167882897.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			_139505167882898.setIs(new Contract("bas:Datapoint bas:DPST-9-1 bas:DPT-9 bas:Datapoint"));

			// add existing translations
			if (translations.containsKey("reference")) {
				for (ArrayList<String> entry : translations.get("reference")) {
					_139505167882898.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}

			// set uri
			_139505167882898.setHref(new Uri("/networks/office/datapoints/temperature_channel_b/1"));
			...
			if (translations.containsKey("P-0341-0_GA-5")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_GA-5")) {
					_139505167882899.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("address")) {
				for (ArrayList<String> entry : translations.get("address")) {
					_1395051678829100.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("function")) {
				for (ArrayList<String> entry : translations.get("function")) {
					_1395051678829101.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}

			// set uri
			_1395051678829101.setHref(new Uri("/networks/office/datapoints/temperature_channel_c/1"));
			...
			if (translations.containsKey("instances")) {
				for (ArrayList<String> entry : translations.get("instances")) {
					_1395051678829102.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			// init object
			_1395051678829103.setName("P-0341-0_DI-11_M-0001_A-9814-01-5F7E_O-2_R-1");
			...
			if (translations.containsKey("P-0341-0_DI-11_M-0001_A-9814-01-5F7E_O-2_R-1")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_DI-11_M-0001_A-9814-01-5F7E_O-2_R-1")) {
					_1395051678829103.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("connector")) {
				for (ArrayList<String> entry : translations.get("connector")) {
					_1395051678829104.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			_1395051678830105.setIs(new Contract("bas:Datapoint bas:DPST-9-1 bas:DPT-9 bas:Datapoint"));

			// add existing translations
			if (translations.containsKey("reference")) {
				for (ArrayList<String> entry : translations.get("reference")) {
					_1395051678830105.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}

			// set uri
			_1395051678830105.setHref(new Uri("/networks/office/datapoints/temperature_channel_c/1"));
			...
			if (translations.containsKey("P-0341-0_GA-6")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_GA-6")) {
					_1395051678830106.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("address")) {
				for (ArrayList<String> entry : translations.get("address")) {
					_1395051678830107.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("function")) {
				for (ArrayList<String> entry : translations.get("function")) {
					_1395051678830108.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}

			// set uri
			_1395051678830108.setHref(new Uri("/networks/office/datapoints/temperature_channel_d/1"));
			...
			if (translations.containsKey("instances")) {
				for (ArrayList<String> entry : translations.get("instances")) {
					_1395051678831109.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			// init object
			_1395051678831110.setName("P-0341-0_DI-11_M-0001_A-9814-01-5F7E_O-3_R-4");
			...
			if (translations.containsKey("P-0341-0_DI-11_M-0001_A-9814-01-5F7E_O-3_R-4")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_DI-11_M-0001_A-9814-01-5F7E_O-3_R-4")) {
					_1395051678831110.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("connector")) {
				for (ArrayList<String> entry : translations.get("connector")) {
					_1395051678831111.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			_1395051678831112.setIs(new Contract("bas:Datapoint bas:DPST-9-1 bas:DPT-9 bas:Datapoint"));

			// add existing translations
			if (translations.containsKey("reference")) {
				for (ArrayList<String> entry : translations.get("reference")) {
					_1395051678831112.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}

			// set uri
			_1395051678831112.setHref(new Uri("/networks/office/datapoints/temperature_channel_d/1"));
			...
			if (translations.containsKey("P-0341-0_GR-5")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_GR-5")) {
					_1395051678832113.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("address")) {
				for (ArrayList<String> entry : translations.get("address")) {
					_1395051678832114.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("groups")) {
				for (ArrayList<String> entry : translations.get("groups")) {
					_1395051678832115.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("P-0341-0_GA-8")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_GA-8")) {
					_1395051678832116.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("address")) {
				for (ArrayList<String> entry : translations.get("address")) {
					_1395051678833117.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("function")) {
				for (ArrayList<String> entry : translations.get("function")) {
					_1395051678833118.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}

			// set uri
			_1395051678833118.setHref(new Uri("/networks/office/datapoints/co2_value/1"));
			...
			if (translations.containsKey("instances")) {
				for (ArrayList<String> entry : translations.get("instances")) {
					_1395051678833119.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			// init object
			_1395051678833120.setName("P-0341-0_DI-7_M-0064_A-FF21-11-DDFC-O0048_O-0_R-1");
			...
			if (translations.containsKey("P-0341-0_DI-7_M-0064_A-FF21-11-DDFC-O0048_O-0_R-1")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_DI-7_M-0064_A-FF21-11-DDFC-O0048_O-0_R-1")) {
					_1395051678833120.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("connector")) {
				for (ArrayList<String> entry : translations.get("connector")) {
					_1395051678833121.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			_1395051678834122.setIs(new Contract("bas:Datapoint bas:DPST-9-8 bas:DPT-9 bas:Datapoint"));

			// add existing translations
			if (translations.containsKey("reference")) {
				for (ArrayList<String> entry : translations.get("reference")) {
					_1395051678834122.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}

			// set uri
			_1395051678834122.setHref(new Uri("/networks/office/datapoints/co2_value/1"));
			...
			if (translations.containsKey("P-0341-0_GA-9")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_GA-9")) {
					_1395051678834123.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("address")) {
				for (ArrayList<String> entry : translations.get("address")) {
					_1395051678834124.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("function")) {
				for (ArrayList<String> entry : translations.get("function")) {
					_1395051678834125.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}

			// set uri
			_1395051678834125.setHref(new Uri("/networks/office/datapoints/rel_humidity_value/1"));
			...
			if (translations.containsKey("instances")) {
				for (ArrayList<String> entry : translations.get("instances")) {
					_1395051678835126.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			// init object
			_1395051678835127.setName("P-0341-0_DI-7_M-0064_A-FF21-11-DDFC-O0048_O-1_R-2");
			...
			if (translations.containsKey("P-0341-0_DI-7_M-0064_A-FF21-11-DDFC-O0048_O-1_R-2")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_DI-7_M-0064_A-FF21-11-DDFC-O0048_O-1_R-2")) {
					_1395051678835127.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("connector")) {
				for (ArrayList<String> entry : translations.get("connector")) {
					_1395051678835128.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			_1395051678835129.setIs(new Contract("bas:Datapoint bas:DPST-5-1 bas:DPT-5-A bas:Datapoint"));

			// add existing translations
			if (translations.containsKey("reference")) {
				for (ArrayList<String> entry : translations.get("reference")) {
					_1395051678835129.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}

			// set uri
			_1395051678835129.setHref(new Uri("/networks/office/datapoints/rel_humidity_value/1"));
			...
			if (translations.containsKey("P-0341-0_GA-10")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_GA-10")) {
					_1395051678835130.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("address")) {
				for (ArrayList<String> entry : translations.get("address")) {
					_1395051678836131.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("function")) {
				for (ArrayList<String> entry : translations.get("function")) {
					_1395051678836132.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}

			// set uri
			_1395051678836132.setHref(new Uri("/networks/office/datapoints/threshold_1_co2/1"));
			...
			if (translations.containsKey("instances")) {
				for (ArrayList<String> entry : translations.get("instances")) {
					_1395051678836133.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			// init object
			_1395051678836134.setName("P-0341-0_DI-7_M-0064_A-FF21-11-DDFC-O0048_O-3_R-50");
			...
			if (translations.containsKey("P-0341-0_DI-7_M-0064_A-FF21-11-DDFC-O0048_O-3_R-50")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_DI-7_M-0064_A-FF21-11-DDFC-O0048_O-3_R-50")) {
					_1395051678836134.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("connector")) {
				for (ArrayList<String> entry : translations.get("connector")) {
					_1395051678837135.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			_1395051678837136.setIs(new Contract("bas:Datapoint bas:DPST-1-1 bas:DPT-1 bas:Datapoint"));

			// add existing translations
			if (translations.containsKey("reference")) {
				for (ArrayList<String> entry : translations.get("reference")) {
					_1395051678837136.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}

			// set uri
			_1395051678837136.setHref(new Uri("/networks/office/datapoints/threshold_1_co2/1"));
			...
			if (translations.containsKey("P-0341-0_GA-11")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_GA-11")) {
					_1395051678837137.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("address")) {
				for (ArrayList<String> entry : translations.get("address")) {
					_1395051678837138.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("function")) {
				for (ArrayList<String> entry : translations.get("function")) {
					_1395051678837139.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}

			// set uri
			_1395051678837139.setHref(new Uri("/networks/office/datapoints/threshold_2_co2/1"));
			...
			if (translations.containsKey("instances")) {
				for (ArrayList<String> entry : translations.get("instances")) {
					_1395051678838140.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			// init object
			_1395051678838141.setName("P-0341-0_DI-7_M-0064_A-FF21-11-DDFC-O0048_O-5_R-55");
			...
			if (translations.containsKey("P-0341-0_DI-7_M-0064_A-FF21-11-DDFC-O0048_O-5_R-55")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_DI-7_M-0064_A-FF21-11-DDFC-O0048_O-5_R-55")) {
					_1395051678838141.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("connector")) {
				for (ArrayList<String> entry : translations.get("connector")) {
					_1395051678838142.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			_1395051678838143.setIs(new Contract("bas:Datapoint bas:DPST-1-1 bas:DPT-1 bas:Datapoint"));

			// add existing translations
			if (translations.containsKey("reference")) {
				for (ArrayList<String> entry : translations.get("reference")) {
					_1395051678838143.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}

			// set uri
			_1395051678838143.setHref(new Uri("/networks/office/datapoints/threshold_2_co2/1"));
			...
			if (translations.containsKey("P-0341-0_GA-12")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_GA-12")) {
					_1395051678839144.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("address")) {
				for (ArrayList<String> entry : translations.get("address")) {
					_1395051678839145.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("function")) {
				for (ArrayList<String> entry : translations.get("function")) {
					_1395051678839146.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}

			// set uri
			_1395051678839146.setHref(new Uri("/networks/office/datapoints/threshold_3_co2/1"));
			...
			if (translations.containsKey("instances")) {
				for (ArrayList<String> entry : translations.get("instances")) {
					_1395051678839147.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			// init object
			_1395051678839148.setName("P-0341-0_DI-7_M-0064_A-FF21-11-DDFC-O0048_O-7_R-60");
			...
			if (translations.containsKey("P-0341-0_DI-7_M-0064_A-FF21-11-DDFC-O0048_O-7_R-60")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_DI-7_M-0064_A-FF21-11-DDFC-O0048_O-7_R-60")) {
					_1395051678839148.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("connector")) {
				for (ArrayList<String> entry : translations.get("connector")) {
					_1395051678840149.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			_1395051678840150.setIs(new Contract("bas:Datapoint bas:DPST-1-1 bas:DPT-1 bas:Datapoint"));

			// add existing translations
			if (translations.containsKey("reference")) {
				for (ArrayList<String> entry : translations.get("reference")) {
					_1395051678840150.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}

			// set uri
			_1395051678840150.setHref(new Uri("/networks/office/datapoints/threshold_3_co2/1"));
			...
			if (translations.containsKey("P-0341-0_GR-6")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_GR-6")) {
					_1395051678840151.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("address")) {
				for (ArrayList<String> entry : translations.get("address")) {
					_1395051678840152.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("groups")) {
				for (ArrayList<String> entry : translations.get("groups")) {
					_1395051678840153.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("P-0341-0_GA-15")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_GA-15")) {
					_1395051678841154.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("address")) {
				for (ArrayList<String> entry : translations.get("address")) {
					_1395051678841155.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("function")) {
				for (ArrayList<String> entry : translations.get("function")) {
					_1395051678841156.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}

			// set uri
			_1395051678841156.setHref(new Uri("/networks/office/datapoints/switch_outer_left/1"));
			...
			if (translations.containsKey("instances")) {
				for (ArrayList<String> entry : translations.get("instances")) {
					_1395051678841157.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			// init object
			_1395051678842158.setName("P-0341-0_DI-10_M-0001_A-2413-01-B14F_O-0_R-10");
			...
			if (translations.containsKey("P-0341-0_DI-10_M-0001_A-2413-01-B14F_O-0_R-10")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_DI-10_M-0001_A-2413-01-B14F_O-0_R-10")) {
					_1395051678842158.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("connector")) {
				for (ArrayList<String> entry : translations.get("connector")) {
					_1395051678842159.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			_1395051678842160.setIs(new Contract("bas:Datapoint bas:DPST-1-1 bas:DPT-1 bas:Datapoint"));

			// add existing translations
			if (translations.containsKey("reference")) {
				for (ArrayList<String> entry : translations.get("reference")) {
					_1395051678842160.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}

			// set uri
			_1395051678842160.setHref(new Uri("/networks/office/datapoints/switch_outer_left/1"));
			...
			if (translations.containsKey("P-0341-0_GA-16")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_GA-16")) {
					_1395051678842161.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("address")) {
				for (ArrayList<String> entry : translations.get("address")) {
					_1395051678842162.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("function")) {
				for (ArrayList<String> entry : translations.get("function")) {
					_1395051678843163.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}

			// set uri
			_1395051678843163.setHref(new Uri("/networks/office/datapoints/switch_centre_left/1"));
			...
			if (translations.containsKey("instances")) {
				for (ArrayList<String> entry : translations.get("instances")) {
					_1395051678843164.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			// init object
			_1395051678843165.setName("P-0341-0_DI-10_M-0001_A-2413-01-B14F_O-2_R-18");
			...
			if (translations.containsKey("P-0341-0_DI-10_M-0001_A-2413-01-B14F_O-2_R-18")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_DI-10_M-0001_A-2413-01-B14F_O-2_R-18")) {
					_1395051678843165.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("connector")) {
				for (ArrayList<String> entry : translations.get("connector")) {
					_1395051678844166.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			_1395051678844167.setIs(new Contract("bas:Datapoint bas:DPST-1-1 bas:DPT-1 bas:Datapoint"));

			// add existing translations
			if (translations.containsKey("reference")) {
				for (ArrayList<String> entry : translations.get("reference")) {
					_1395051678844167.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}

			// set uri
			_1395051678844167.setHref(new Uri("/networks/office/datapoints/switch_centre_left/1"));
			...
			if (translations.containsKey("P-0341-0_GA-17")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_GA-17")) {
					_1395051678844168.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("address")) {
				for (ArrayList<String> entry : translations.get("address")) {
					_1395051678845169.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("function")) {
				for (ArrayList<String> entry : translations.get("function")) {
					_1395051678845170.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}

			// set uri
			_1395051678845170.setHref(new Uri("/networks/office/datapoints/switch_centre_right/1"));
			...
			if (translations.containsKey("instances")) {
				for (ArrayList<String> entry : translations.get("instances")) {
					_1395051678846171.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			// init object
			_1395051678846172.setName("P-0341-0_DI-10_M-0001_A-2413-01-B14F_O-4_R-27");
			...
			if (translations.containsKey("P-0341-0_DI-10_M-0001_A-2413-01-B14F_O-4_R-27")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_DI-10_M-0001_A-2413-01-B14F_O-4_R-27")) {
					_1395051678846172.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("connector")) {
				for (ArrayList<String> entry : translations.get("connector")) {
					_1395051678846173.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			_1395051678847174.setIs(new Contract("bas:Datapoint bas:DPST-1-1 bas:DPT-1 bas:Datapoint"));

			// add existing translations
			if (translations.containsKey("reference")) {
				for (ArrayList<String> entry : translations.get("reference")) {
					_1395051678847174.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}

			// set uri
			_1395051678847174.setHref(new Uri("/networks/office/datapoints/switch_centre_right/1"));
			...
			if (translations.containsKey("P-0341-0_GA-18")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_GA-18")) {
					_1395051678847175.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("address")) {
				for (ArrayList<String> entry : translations.get("address")) {
					_1395051678847176.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("function")) {
				for (ArrayList<String> entry : translations.get("function")) {
					_1395051678848177.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}

			// set uri
			_1395051678848177.setHref(new Uri("/networks/office/datapoints/dimming_on_off_outer_right/1"));
			...
			if (translations.containsKey("instances")) {
				for (ArrayList<String> entry : translations.get("instances")) {
					_1395051678848178.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			// init object
			_1395051678848179.setName("P-0341-0_DI-10_M-0001_A-2413-01-B14F_O-6_R-38");
			...
			if (translations.containsKey("P-0341-0_DI-10_M-0001_A-2413-01-B14F_O-6_R-38")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_DI-10_M-0001_A-2413-01-B14F_O-6_R-38")) {
					_1395051678848179.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("connector")) {
				for (ArrayList<String> entry : translations.get("connector")) {
					_1395051678848180.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			_1395051678849181.setIs(new Contract("bas:Datapoint bas:DPST-1-1 bas:DPT-1 bas:Datapoint"));

			// add existing translations
			if (translations.containsKey("reference")) {
				for (ArrayList<String> entry : translations.get("reference")) {
					_1395051678849181.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}

			// set uri
			_1395051678849181.setHref(new Uri("/networks/office/datapoints/dimming_on_off_outer_right/1"));
			...
			if (translations.containsKey("P-0341-0_GA-19")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_GA-19")) {
					_1395051678849182.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("address")) {
				for (ArrayList<String> entry : translations.get("address")) {
					_1395051678849183.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("function")) {
				for (ArrayList<String> entry : translations.get("function")) {
					_1395051678849184.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}

			// set uri
			_1395051678849184.setHref(new Uri("/networks/office/datapoints/dimming_outer_right/1"));
			...
			if (translations.containsKey("instances")) {
				for (ArrayList<String> entry : translations.get("instances")) {
					_1395051678860185.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			// init object
			_1395051678860186.setName("P-0341-0_DI-10_M-0001_A-2413-01-B14F_O-7_R-41");
			...
			if (translations.containsKey("P-0341-0_DI-10_M-0001_A-2413-01-B14F_O-7_R-41")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_DI-10_M-0001_A-2413-01-B14F_O-7_R-41")) {
					_1395051678860186.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("connector")) {
				for (ArrayList<String> entry : translations.get("connector")) {
					_1395051678861187.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			_1395051678861188.setIs(new Contract("bas:Datapoint bas:DPST-3-7 bas:DPT-3 bas:Datapoint"));

			// add existing translations
			if (translations.containsKey("reference")) {
				for (ArrayList<String> entry : translations.get("reference")) {
					_1395051678861188.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}

			// set uri
			_1395051678861188.setHref(new Uri("/networks/office/datapoints/dimming_outer_right/1"));
			...
			if (translations.containsKey("topology")) {
				for (ArrayList<String> entry : translations.get("topology")) {
					_1395051678861189.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("building")) {
				for (ArrayList<String> entry : translations.get("building")) {
					_1395051678862190.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("domains")) {
				for (ArrayList<String> entry : translations.get("domains")) {
					_1395051678862191.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (groupAddresses.containsKey("P-0341-0_DI-7_M-0064_A-FF21-11-DDFC-O0048_O-1_R-2"))
				init__1395051678862192.setGroupAddress(
						new GroupAddress(groupAddresses.get("P-0341-0_DI-7_M-0064_A-FF21-11-DDFC-O0048_O-1_R-2")));

			init__1395051678862192.setDisplay("Physical Value");

			init__1395051678862192.setDisplayName("Rel. humidity value");

			init__1395051678862192.setName("P-0341-0_DI-7_M-0064_A-FF21-11-DDFC-O0048_O-1_R-2");

			init__1395051678862192.setReadable(true);
			init__1395051678862192.setWritable(false);

			// create datapoint
			DPST_5_1_ImplKnx _1395051678862192 = new DPST_5_1_ImplKnx(knxConnector, init__1395051678862192);

			// add existing translations
			if (translations.containsKey("P-0341-0_DI-7_M-0064_A-FF21-11-DDFC-O0048_O-1_R-2")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_DI-7_M-0064_A-FF21-11-DDFC-O0048_O-1_R-2")) {
					_1395051678862192.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}

			// set uri
			_1395051678862192.setHref(new Uri("/networks/office/datapoints/rel_humidity_value/1"));
			...
			_1395051678862193.setDisplay("Productinfo - see file:   5271ab01_tpi_e.pdf");
			...
			if (translations.containsKey("P-0341-0_DI-2")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_DI-2")) {
					_1395051678862193.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}

			// set uri
			_1395051678862193.setHref(new Uri("/networks/office/entities/universal_dimmer_n_527/1"));
			...
			if (translations.containsKey("manufacturer")) {
				for (ArrayList<String> entry : translations.get("manufacturer")) {
					_1395051678863194.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("orderNumber")) {
				for (ArrayList<String> entry : translations.get("orderNumber")) {
					_1395051678863195.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("datapoints")) {
				for (ArrayList<String> entry : translations.get("datapoints")) {
					_1395051678863196.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			// init object
			_1395051678863197.setName("P-0341-0_DI-2_M-0001_A-6102-01-A218_O-1_R-1");
			...
			if (translations.containsKey("P-0341-0_DI-2_M-0001_A-6102-01-A218_O-1_R-1")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_DI-2_M-0001_A-6102-01-A218_O-1_R-1")) {
					_1395051678863197.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}

			// set uri
			_1395051678863197.setHref(new Uri("/networks/office/datapoints/dimming/1"));
			...
			// init object
			_1395051678864198.setName("P-0341-0_DI-2_M-0001_A-6102-01-A218_O-3_R-3");
			...
			if (translations.containsKey("P-0341-0_DI-2_M-0001_A-6102-01-A218_O-3_R-3")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_DI-2_M-0001_A-6102-01-A218_O-3_R-3")) {
					_1395051678864198.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}

			// set uri
			_1395051678864198.setHref(new Uri("/networks/office/datapoints/status/1"));
			...
			// init object
			_1395051678864199.setName("P-0341-0_DI-2_M-0001_A-6102-01-A218_O-0_R-0");
			...
			if (translations.containsKey("P-0341-0_DI-2_M-0001_A-6102-01-A218_O-0_R-0")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_DI-2_M-0001_A-6102-01-A218_O-0_R-0")) {
					_1395051678864199.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}

			// set uri
			_1395051678864199.setHref(new Uri("/networks/office/datapoints/switch_status/1"));
			...
			_1395051678864200.setDisplay("Productinfo - see file:   5221ab02_tpi_e.pdf");
			...
			if (translations.containsKey("P-0341-0_DI-1")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_DI-1")) {
					_1395051678864200.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}

			// set uri
			_1395051678864200.setHref(new Uri("/networks/office/entities/shutter_switch_n_522_02/1"));
			...
			if (translations.containsKey("manufacturer")) {
				for (ArrayList<String> entry : translations.get("manufacturer")) {
					_1395051678864201.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("orderNumber")) {
				for (ArrayList<String> entry : translations.get("orderNumber")) {
					_1395051678864202.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (groupAddresses.containsKey("P-0341-0_DI-11_M-0001_A-9814-01-5F7E_O-0_R-2"))
				init__1395051678865203.setGroupAddress(
						new GroupAddress(groupAddresses.get("P-0341-0_DI-11_M-0001_A-9814-01-5F7E_O-0_R-2")));

			init__1395051678865203.setDisplay("°C-value (EIS5)");

			init__1395051678865203.setDisplayName("Temperature, Channel A");

			init__1395051678865203.setName("P-0341-0_DI-11_M-0001_A-9814-01-5F7E_O-0_R-2");

			init__1395051678865203.setReadable(true);
			init__1395051678865203.setWritable(false);

			// create datapoint
			DPST_9_1_ImplKnx _1395051678865203 = new DPST_9_1_ImplKnx(knxConnector, init__1395051678865203);

			// add existing translations
			if (translations.containsKey("P-0341-0_DI-11_M-0001_A-9814-01-5F7E_O-0_R-2")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_DI-11_M-0001_A-9814-01-5F7E_O-0_R-2")) {
					_1395051678865203.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}

			// set uri
			_1395051678865203.setHref(new Uri("/networks/office/datapoints/temperature_channel_a/1"));
			...
			if (groupAddresses.containsKey("P-0341-0_DI-10_M-0001_A-2413-01-B14F_O-6_R-38"))
				init__1395051678865204.setGroupAddress(
						new GroupAddress(groupAddresses.get("P-0341-0_DI-10_M-0001_A-2413-01-B14F_O-6_R-38")));

			init__1395051678865204.setDisplay("On / Off");

			init__1395051678865204.setDisplayName("Dimming On / Off outer right");

			init__1395051678865204.setName("P-0341-0_DI-10_M-0001_A-2413-01-B14F_O-6_R-38");

			init__1395051678865204.setReadable(false);
			init__1395051678865204.setWritable(true);

			// create datapoint
			DPST_1_1_ImplKnx _1395051678865204 = new DPST_1_1_ImplKnx(knxConnector, init__1395051678865204);

			// add existing translations
			if (translations.containsKey("P-0341-0_DI-10_M-0001_A-2413-01-B14F_O-6_R-38")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_DI-10_M-0001_A-2413-01-B14F_O-6_R-38")) {
					_1395051678865204.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}

			// set uri
			_1395051678865204.setHref(new Uri("/networks/office/datapoints/dimming_on_off_outer_right/1"));
			...
			_1395051678865205.setDisplayName("Push button 4-f UP 245 DELTA profil (without sym)");

			_1395051678865205.setDisplay("Productinfo - see file:   24_2ab_1_tpi_e.pdf");
			...
			if (translations.containsKey("P-0341-0_DI-10")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_DI-10")) {
					_1395051678865205.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}

			// set uri
			_1395051678865205
					.setHref(new Uri("/networks/office/entities/push_button_4_f_up_245_delta_profil_without_sym/1"));
			...
			if (translations.containsKey("manufacturer")) {
				for (ArrayList<String> entry : translations.get("manufacturer")) {
					_1395051678866206.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("orderNumber")) {
				for (ArrayList<String> entry : translations.get("orderNumber")) {
					_1395051678866207.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("datapoints")) {
				for (ArrayList<String> entry : translations.get("datapoints")) {
					_1395051678866208.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			// init object
			_1395051678866209.setName("P-0341-0_DI-10_M-0001_A-2413-01-B14F_O-0_R-10");
			...
			if (translations.containsKey("P-0341-0_DI-10_M-0001_A-2413-01-B14F_O-0_R-10")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_DI-10_M-0001_A-2413-01-B14F_O-0_R-10")) {
					_1395051678866209.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}

			// set uri
			_1395051678866209.setHref(new Uri("/networks/office/datapoints/switch_outer_left/1"));
			...
			// init object
			_1395051678866210.setName("P-0341-0_DI-10_M-0001_A-2413-01-B14F_O-2_R-18");
			...
			if (translations.containsKey("P-0341-0_DI-10_M-0001_A-2413-01-B14F_O-2_R-18")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_DI-10_M-0001_A-2413-01-B14F_O-2_R-18")) {
					_1395051678866210.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}

			// set uri
			_1395051678866210.setHref(new Uri("/networks/office/datapoints/switch_centre_left/1"));
			...
			// init object
			_1395051678867211.setName("P-0341-0_DI-10_M-0001_A-2413-01-B14F_O-7_R-41");
			...
			if (translations.containsKey("P-0341-0_DI-10_M-0001_A-2413-01-B14F_O-7_R-41")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_DI-10_M-0001_A-2413-01-B14F_O-7_R-41")) {
					_1395051678867211.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}

			// set uri
			_1395051678867211.setHref(new Uri("/networks/office/datapoints/dimming_outer_right/1"));
			...
			// init object
			_1395051678867212.setName("P-0341-0_DI-10_M-0001_A-2413-01-B14F_O-6_R-38");
			...
			if (translations.containsKey("P-0341-0_DI-10_M-0001_A-2413-01-B14F_O-6_R-38")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_DI-10_M-0001_A-2413-01-B14F_O-6_R-38")) {
					_1395051678867212.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}

			// set uri
			_1395051678867212.setHref(new Uri("/networks/office/datapoints/dimming_on_off_outer_right/1"));
			...
			// init object
			_1395051678867213.setName("P-0341-0_DI-10_M-0001_A-2413-01-B14F_O-4_R-27");
			...
			if (translations.containsKey("P-0341-0_DI-10_M-0001_A-2413-01-B14F_O-4_R-27")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_DI-10_M-0001_A-2413-01-B14F_O-4_R-27")) {
					_1395051678867213.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}

			// set uri
			_1395051678867213.setHref(new Uri("/networks/office/datapoints/switch_centre_right/1"));
			...
			if (groupAddresses.containsKey("P-0341-0_DI-11_M-0001_A-9814-01-5F7E_O-2_R-1"))
				init__1395051678867214.setGroupAddress(
						new GroupAddress(groupAddresses.get("P-0341-0_DI-11_M-0001_A-9814-01-5F7E_O-2_R-1")));

			init__1395051678867214.setDisplay("°C-value (EIS5)");

			init__1395051678867214.setDisplayName("Temperature, Channel C");

			init__1395051678867214.setName("P-0341-0_DI-11_M-0001_A-9814-01-5F7E_O-2_R-1");

			init__1395051678867214.setReadable(true);
			init__1395051678867214.setWritable(false);

			// create datapoint
			DPST_9_1_ImplKnx _1395051678867214 = new DPST_9_1_ImplKnx(knxConnector, init__1395051678867214);

			// add existing translations
			if (translations.containsKey("P-0341-0_DI-11_M-0001_A-9814-01-5F7E_O-2_R-1")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_DI-11_M-0001_A-9814-01-5F7E_O-2_R-1")) {
					_1395051678867214.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}

			// set uri
			_1395051678867214.setHref(new Uri("/networks/office/datapoints/temperature_channel_c/1"));
			...
			_1395051678867215.setDisplayName("Switching actuator N 567/01, (8 Amp)");

			_1395051678867215.setDisplay("Productinfo - see file:   5671ab01_tpi_e.pdf");
			...
			if (translations.containsKey("P-0341-0_DI-3")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_DI-3")) {
					_1395051678867215.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}

			// set uri
			_1395051678867215.setHref(new Uri("/networks/office/entities/switching_actuator_n_567_01_8_amp/1"));
			...
			if (translations.containsKey("manufacturer")) {
				for (ArrayList<String> entry : translations.get("manufacturer")) {
					_1395051678868216.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("orderNumber")) {
				for (ArrayList<String> entry : translations.get("orderNumber")) {
					_1395051678868217.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("datapoints")) {
				for (ArrayList<String> entry : translations.get("datapoints")) {
					_1395051678868218.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			// init object
			_1395051678868219.setName("P-0341-0_DI-3_M-0001_A-9803-03-3F77_O-3_R-4");
			...
			if (translations.containsKey("P-0341-0_DI-3_M-0001_A-9803-03-3F77_O-3_R-4")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_DI-3_M-0001_A-9803-03-3F77_O-3_R-4")) {
					_1395051678868219.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}

			// set uri
			_1395051678868219.setHref(new Uri("/networks/office/datapoints/switch_channel_a/1"));
			...
			if (groupAddresses.containsKey("P-0341-0_DI-7_M-0064_A-FF21-11-DDFC-O0048_O-5_R-55"))
				init__1395051678868220.setGroupAddress(
						new GroupAddress(groupAddresses.get("P-0341-0_DI-7_M-0064_A-FF21-11-DDFC-O0048_O-5_R-55")));

			init__1395051678868220.setDisplay("Switch");

			init__1395051678868220.setDisplayName("Threshold 2 CO2");

			init__1395051678868220.setName("P-0341-0_DI-7_M-0064_A-FF21-11-DDFC-O0048_O-5_R-55");

			init__1395051678868220.setReadable(true);
			init__1395051678868220.setWritable(false);

			// create datapoint
			DPST_1_1_ImplKnx _1395051678868220 = new DPST_1_1_ImplKnx(knxConnector, init__1395051678868220);

			// add existing translations
			if (translations.containsKey("P-0341-0_DI-7_M-0064_A-FF21-11-DDFC-O0048_O-5_R-55")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_DI-7_M-0064_A-FF21-11-DDFC-O0048_O-5_R-55")) {
					_1395051678868220.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}

			// set uri
			_1395051678868220.setHref(new Uri("/networks/office/datapoints/threshold_2_co2/1"));
			...
			if (groupAddresses.containsKey("P-0341-0_DI-11_M-0001_A-9814-01-5F7E_O-3_R-4"))
				init__1395051678869221.setGroupAddress(
						new GroupAddress(groupAddresses.get("P-0341-0_DI-11_M-0001_A-9814-01-5F7E_O-3_R-4")));

			init__1395051678869221.setDisplay("°C-value (EIS5)");

			init__1395051678869221.setDisplayName("Temperature, Channel D");

			init__1395051678869221.setName("P-0341-0_DI-11_M-0001_A-9814-01-5F7E_O-3_R-4");

			init__1395051678869221.setReadable(true);
			init__1395051678869221.setWritable(false);

			// create datapoint
			DPST_9_1_ImplKnx _1395051678869221 = new DPST_9_1_ImplKnx(knxConnector, init__1395051678869221);

			// add existing translations
			if (translations.containsKey("P-0341-0_DI-11_M-0001_A-9814-01-5F7E_O-3_R-4")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_DI-11_M-0001_A-9814-01-5F7E_O-3_R-4")) {
					_1395051678869221.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}

			// set uri
			_1395051678869221.setHref(new Uri("/networks/office/datapoints/temperature_channel_d/1"));
			...
			if (groupAddresses.containsKey("P-0341-0_DI-10_M-0001_A-2413-01-B14F_O-4_R-27"))
				init__1395051678869222.setGroupAddress(
						new GroupAddress(groupAddresses.get("P-0341-0_DI-10_M-0001_A-2413-01-B14F_O-4_R-27")));

			init__1395051678869222.setDisplay("On / Off");

			init__1395051678869222.setDisplayName("Switch centre right");

			init__1395051678869222.setName("P-0341-0_DI-10_M-0001_A-2413-01-B14F_O-4_R-27");

			init__1395051678869222.setReadable(false);
			init__1395051678869222.setWritable(true);

			// create datapoint
			DPST_1_1_ImplKnx _1395051678869222 = new DPST_1_1_ImplKnx(knxConnector, init__1395051678869222);

			// add existing translations
			if (translations.containsKey("P-0341-0_DI-10_M-0001_A-2413-01-B14F_O-4_R-27")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_DI-10_M-0001_A-2413-01-B14F_O-4_R-27")) {
					_1395051678869222.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}

			// set uri
			_1395051678869222.setHref(new Uri("/networks/office/datapoints/switch_centre_right/1"));
			...
			_1395051678869223.setDisplay("Productinfo - see file:   2581ab02_tpi_e.pdf");
			...
			if (translations.containsKey("P-0341-0_DI-11")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_DI-11")) {
					_1395051678869223.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}

			// set uri
			_1395051678869223.setHref(new Uri("/networks/office/entities/temperature_sensor_n_258_02/1"));
			...
			if (translations.containsKey("manufacturer")) {
				for (ArrayList<String> entry : translations.get("manufacturer")) {
					_1395051678869224.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("orderNumber")) {
				for (ArrayList<String> entry : translations.get("orderNumber")) {
					_1395051678870225.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("datapoints")) {
				for (ArrayList<String> entry : translations.get("datapoints")) {
					_1395051678870226.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			// init object
			_1395051678870227.setName("P-0341-0_DI-11_M-0001_A-9814-01-5F7E_O-0_R-2");
			...
			if (translations.containsKey("P-0341-0_DI-11_M-0001_A-9814-01-5F7E_O-0_R-2")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_DI-11_M-0001_A-9814-01-5F7E_O-0_R-2")) {
					_1395051678870227.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}

			// set uri
			_1395051678870227.setHref(new Uri("/networks/office/datapoints/temperature_channel_a/1"));
			...
			// init object
			_1395051678870228.setName("P-0341-0_DI-11_M-0001_A-9814-01-5F7E_O-1_R-3");
			...
			if (translations.containsKey("P-0341-0_DI-11_M-0001_A-9814-01-5F7E_O-1_R-3")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_DI-11_M-0001_A-9814-01-5F7E_O-1_R-3")) {
					_1395051678870228.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}

			// set uri
			_1395051678870228.setHref(new Uri("/networks/office/datapoints/temperature_channel_b/1"));
			...
			// init object
			_1395051678870229.setName("P-0341-0_DI-11_M-0001_A-9814-01-5F7E_O-2_R-1");
			...
			if (translations.containsKey("P-0341-0_DI-11_M-0001_A-9814-01-5F7E_O-2_R-1")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_DI-11_M-0001_A-9814-01-5F7E_O-2_R-1")) {
					_1395051678870229.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}

			// set uri
			_1395051678870229.setHref(new Uri("/networks/office/datapoints/temperature_channel_c/1"));
			...
			// init object
			_1395051678871230.setName("P-0341-0_DI-11_M-0001_A-9814-01-5F7E_O-3_R-4");
			...
			if (translations.containsKey("P-0341-0_DI-11_M-0001_A-9814-01-5F7E_O-3_R-4")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_DI-11_M-0001_A-9814-01-5F7E_O-3_R-4")) {
					_1395051678871230.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}

			// set uri
			_1395051678871230.setHref(new Uri("/networks/office/datapoints/temperature_channel_d/1"));
			...
			if (groupAddresses.containsKey("P-0341-0_DI-11_M-0001_A-9814-01-5F7E_O-1_R-3"))
				init__1395051678871231.setGroupAddress(
						new GroupAddress(groupAddresses.get("P-0341-0_DI-11_M-0001_A-9814-01-5F7E_O-1_R-3")));

			init__1395051678871231.setDisplay("°C-value (EIS5)");

			init__1395051678871231.setDisplayName("Temperature, Channel B");

			init__1395051678871231.setName("P-0341-0_DI-11_M-0001_A-9814-01-5F7E_O-1_R-3");

			init__1395051678871231.setReadable(true);
			init__1395051678871231.setWritable(false);

			// create datapoint
			DPST_9_1_ImplKnx _1395051678871231 = new DPST_9_1_ImplKnx(knxConnector, init__1395051678871231);

			// add existing translations
			if (translations.containsKey("P-0341-0_DI-11_M-0001_A-9814-01-5F7E_O-1_R-3")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_DI-11_M-0001_A-9814-01-5F7E_O-1_R-3")) {
					_1395051678871231.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}

			// set uri
			_1395051678871231.setHref(new Uri("/networks/office/datapoints/temperature_channel_b/1"));
			...
			if (groupAddresses.containsKey("P-0341-0_DI-7_M-0064_A-FF21-11-DDFC-O0048_O-7_R-60"))
				init__1395051678871232.setGroupAddress(
						new GroupAddress(groupAddresses.get("P-0341-0_DI-7_M-0064_A-FF21-11-DDFC-O0048_O-7_R-60")));

			init__1395051678871232.setDisplay("Switch");

			init__1395051678871232.setDisplayName("Threshold 3 CO2");

			init__1395051678871232.setName("P-0341-0_DI-7_M-0064_A-FF21-11-DDFC-O0048_O-7_R-60");

			init__1395051678871232.setReadable(true);
			init__1395051678871232.setWritable(false);

			// create datapoint
			DPST_1_1_ImplKnx _1395051678871232 = new DPST_1_1_ImplKnx(knxConnector, init__1395051678871232);

			// add existing translations
			if (translations.containsKey("P-0341-0_DI-7_M-0064_A-FF21-11-DDFC-O0048_O-7_R-60")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_DI-7_M-0064_A-FF21-11-DDFC-O0048_O-7_R-60")) {
					_1395051678871232.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}

			// set uri
			_1395051678871232.setHref(new Uri("/networks/office/datapoints/threshold_3_co2/1"));
			...
			if (groupAddresses.containsKey("P-0341-0_DI-7_M-0064_A-FF21-11-DDFC-O0048_O-0_R-1"))
				init__1395051678871233.setGroupAddress(
						new GroupAddress(groupAddresses.get("P-0341-0_DI-7_M-0064_A-FF21-11-DDFC-O0048_O-0_R-1")));

			init__1395051678871233.setDisplay("Physical Value");

			init__1395051678871233.setDisplayName("CO2 Value");

			init__1395051678871233.setName("P-0341-0_DI-7_M-0064_A-FF21-11-DDFC-O0048_O-0_R-1");

			init__1395051678871233.setReadable(true);
			init__1395051678871233.setWritable(false);

			// create datapoint
			DPST_9_8_ImplKnx _1395051678871233 = new DPST_9_8_ImplKnx(knxConnector, init__1395051678871233);

			// add existing translations
			if (translations.containsKey("P-0341-0_DI-7_M-0064_A-FF21-11-DDFC-O0048_O-0_R-1")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_DI-7_M-0064_A-FF21-11-DDFC-O0048_O-0_R-1")) {
					_1395051678871233.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}

			// set uri
			_1395051678871233.setHref(new Uri("/networks/office/datapoints/co2_value/1"));
			...
			if (groupAddresses.containsKey("P-0341-0_DI-2_M-0001_A-6102-01-A218_O-3_R-3"))
				init__1395051678872234.setGroupAddress(
						new GroupAddress(groupAddresses.get("P-0341-0_DI-2_M-0001_A-6102-01-A218_O-3_R-3")));

			init__1395051678872234.setDisplay("8-bit Value");

			init__1395051678872234.setDisplayName("Status");

			init__1395051678872234.setName("P-0341-0_DI-2_M-0001_A-6102-01-A218_O-3_R-3");

			init__1395051678872234.setReadable(true);
			init__1395051678872234.setWritable(false);

			// create datapoint
			DPST_5_1_ImplKnx _1395051678872234 = new DPST_5_1_ImplKnx(knxConnector, init__1395051678872234);

			// add existing translations
			if (translations.containsKey("P-0341-0_DI-2_M-0001_A-6102-01-A218_O-3_R-3")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_DI-2_M-0001_A-6102-01-A218_O-3_R-3")) {
					_1395051678872234.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}

			// set uri
			_1395051678872234.setHref(new Uri("/networks/office/datapoints/status/1"));
			...
			if (groupAddresses.containsKey("P-0341-0_DI-3_M-0001_A-9803-03-3F77_O-3_R-4"))
				init__1395051678872235.setGroupAddress(
						new GroupAddress(groupAddresses.get("P-0341-0_DI-3_M-0001_A-9803-03-3F77_O-3_R-4")));

			init__1395051678872235.setDisplay("On / Off");

			init__1395051678872235.setDisplayName("Switch, Channel A");

			init__1395051678872235.setName("P-0341-0_DI-3_M-0001_A-9803-03-3F77_O-3_R-4");

			init__1395051678872235.setReadable(false);
			init__1395051678872235.setWritable(true);

			// create datapoint
			DPST_1_1_ImplKnx _1395051678872235 = new DPST_1_1_ImplKnx(knxConnector, init__1395051678872235);

			// add existing translations
			if (translations.containsKey("P-0341-0_DI-3_M-0001_A-9803-03-3F77_O-3_R-4")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_DI-3_M-0001_A-9803-03-3F77_O-3_R-4")) {
					_1395051678872235.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}

			// set uri
			_1395051678872235.setHref(new Uri("/networks/office/datapoints/switch_channel_a/1"));
			...
			if (groupAddresses.containsKey("P-0341-0_DI-10_M-0001_A-2413-01-B14F_O-2_R-18"))
				init__1395051678872236.setGroupAddress(
						new GroupAddress(groupAddresses.get("P-0341-0_DI-10_M-0001_A-2413-01-B14F_O-2_R-18")));

			init__1395051678872236.setDisplay("On / Off");

			init__1395051678872236.setDisplayName("Switch centre left");

			init__1395051678872236.setName("P-0341-0_DI-10_M-0001_A-2413-01-B14F_O-2_R-18");

			init__1395051678872236.setReadable(false);
			init__1395051678872236.setWritable(true);

			// create datapoint
			DPST_1_1_ImplKnx _1395051678872236 = new DPST_1_1_ImplKnx(knxConnector, init__1395051678872236);

			// add existing translations
			if (translations.containsKey("P-0341-0_DI-10_M-0001_A-2413-01-B14F_O-2_R-18")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_DI-10_M-0001_A-2413-01-B14F_O-2_R-18")) {
					_1395051678872236.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}

			// set uri
			_1395051678872236.setHref(new Uri("/networks/office/datapoints/switch_centre_left/1"));
			...
			_1395051678872237.setDisplayName("KNX CO², Humidity and Temperature Sensor");
			...
			if (translations.containsKey("P-0341-0_DI-7")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_DI-7")) {
					_1395051678872237.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}

			// set uri
			_1395051678872237.setHref(new Uri("/networks/office/entities/knx_co2_humidity_and_temperature_sensor/1"));
			...
			if (translations.containsKey("manufacturer")) {
				for (ArrayList<String> entry : translations.get("manufacturer")) {
					_1395051678873238.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("orderNumber")) {
				for (ArrayList<String> entry : translations.get("orderNumber")) {
					_1395051678873239.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("datapoints")) {
				for (ArrayList<String> entry : translations.get("datapoints")) {
					_1395051678873240.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			// init object
			_1395051678873241.setName("P-0341-0_DI-7_M-0064_A-FF21-11-DDFC-O0048_O-3_R-50");
			...
			if (translations.containsKey("P-0341-0_DI-7_M-0064_A-FF21-11-DDFC-O0048_O-3_R-50")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_DI-7_M-0064_A-FF21-11-DDFC-O0048_O-3_R-50")) {
					_1395051678873241.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}

			// set uri
			_1395051678873241.setHref(new Uri("/networks/office/datapoints/threshold_1_co2/1"));
			...
			// init object
			_1395051678873242.setName("P-0341-0_DI-7_M-0064_A-FF21-11-DDFC-O0048_O-5_R-55");
			...
			if (translations.containsKey("P-0341-0_DI-7_M-0064_A-FF21-11-DDFC-O0048_O-5_R-55")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_DI-7_M-0064_A-FF21-11-DDFC-O0048_O-5_R-55")) {
					_1395051678873242.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}

			// set uri
			_1395051678873242.setHref(new Uri("/networks/office/datapoints/threshold_2_co2/1"));
			...
			// init object
			_1395051678874243.setName("P-0341-0_DI-7_M-0064_A-FF21-11-DDFC-O0048_O-7_R-60");
			...
			if (translations.containsKey("P-0341-0_DI-7_M-0064_A-FF21-11-DDFC-O0048_O-7_R-60")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_DI-7_M-0064_A-FF21-11-DDFC-O0048_O-7_R-60")) {
					_1395051678874243.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}

			// set uri
			_1395051678874243.setHref(new Uri("/networks/office/datapoints/threshold_3_co2/1"));
			...
			// init object
			_1395051678874244.setName("P-0341-0_DI-7_M-0064_A-FF21-11-DDFC-O0048_O-0_R-1");
			...
			if (translations.containsKey("P-0341-0_DI-7_M-0064_A-FF21-11-DDFC-O0048_O-0_R-1")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_DI-7_M-0064_A-FF21-11-DDFC-O0048_O-0_R-1")) {
					_1395051678874244.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}

			// set uri
			_1395051678874244.setHref(new Uri("/networks/office/datapoints/co2_value/1"));
			...
			// init object
			_1395051678875245.setName("P-0341-0_DI-7_M-0064_A-FF21-11-DDFC-O0048_O-1_R-2");
			...
			if (translations.containsKey("P-0341-0_DI-7_M-0064_A-FF21-11-DDFC-O0048_O-1_R-2")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_DI-7_M-0064_A-FF21-11-DDFC-O0048_O-1_R-2")) {
					_1395051678875245.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}

			// set uri
			_1395051678875245.setHref(new Uri("/networks/office/datapoints/rel_humidity_value/1"));
			...
			_1395051678875246.setDisplayName("Push button 2-fold UP 211 DELTA studio (red lens)");

			_1395051678875246.setDisplay("Productinfo - see file:   2112_b___tpi_e.pdf");
			...
			if (translations.containsKey("P-0341-0_DI-9")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_DI-9")) {
					_1395051678875246.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}

			// set uri
			_1395051678875246
					.setHref(new Uri("/networks/office/entities/push_button_2_fold_up_211_delta_studio_red_lens/1"));
			...
			if (translations.containsKey("manufacturer")) {
				for (ArrayList<String> entry : translations.get("manufacturer")) {
					_1395051678875247.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (translations.containsKey("orderNumber")) {
				for (ArrayList<String> entry : translations.get("orderNumber")) {
					_1395051678875248.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}
			...
			if (groupAddresses.containsKey("P-0341-0_DI-10_M-0001_A-2413-01-B14F_O-0_R-10"))
				init__1395051678876249.setGroupAddress(
						new GroupAddress(groupAddresses.get("P-0341-0_DI-10_M-0001_A-2413-01-B14F_O-0_R-10")));

			init__1395051678876249.setDisplay("Off / On");

			init__1395051678876249.setDisplayName("Switch outer left");

			init__1395051678876249.setName("P-0341-0_DI-10_M-0001_A-2413-01-B14F_O-0_R-10");

			init__1395051678876249.setReadable(false);
			init__1395051678876249.setWritable(true);

			// create datapoint
			DPST_1_1_ImplKnx _1395051678876249 = new DPST_1_1_ImplKnx(knxConnector, init__1395051678876249);

			// add existing translations
			if (translations.containsKey("P-0341-0_DI-10_M-0001_A-2413-01-B14F_O-0_R-10")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_DI-10_M-0001_A-2413-01-B14F_O-0_R-10")) {
					_1395051678876249.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}

			// set uri
			_1395051678876249.setHref(new Uri("/networks/office/datapoints/switch_outer_left/1"));
			...
			if (groupAddresses.containsKey("P-0341-0_DI-7_M-0064_A-FF21-11-DDFC-O0048_O-3_R-50"))
				init__1395051678876250.setGroupAddress(
						new GroupAddress(groupAddresses.get("P-0341-0_DI-7_M-0064_A-FF21-11-DDFC-O0048_O-3_R-50")));

			init__1395051678876250.setDisplay("Switch");

			init__1395051678876250.setDisplayName("Threshold 1 CO2");

			init__1395051678876250.setName("P-0341-0_DI-7_M-0064_A-FF21-11-DDFC-O0048_O-3_R-50");

			init__1395051678876250.setReadable(true);
			init__1395051678876250.setWritable(false);

			// create datapoint
			DPST_1_1_ImplKnx _1395051678876250 = new DPST_1_1_ImplKnx(knxConnector, init__1395051678876250);

			// add existing translations
			if (translations.containsKey("P-0341-0_DI-7_M-0064_A-FF21-11-DDFC-O0048_O-3_R-50")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_DI-7_M-0064_A-FF21-11-DDFC-O0048_O-3_R-50")) {
					_1395051678876250.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}

			// set uri
			_1395051678876250.setHref(new Uri("/networks/office/datapoints/threshold_1_co2/1"));
			...
			if (groupAddresses.containsKey("P-0341-0_DI-2_M-0001_A-6102-01-A218_O-0_R-0"))
				init__1395051678876251.setGroupAddress(
						new GroupAddress(groupAddresses.get("P-0341-0_DI-2_M-0001_A-6102-01-A218_O-0_R-0")));

			init__1395051678876251.setDisplay("On / Off");

			init__1395051678876251.setDisplayName("Switch, Status");

			init__1395051678876251.setName("P-0341-0_DI-2_M-0001_A-6102-01-A218_O-0_R-0");

			init__1395051678876251.setReadable(false);
			init__1395051678876251.setWritable(true);

			// create datapoint
			DPST_1_1_ImplKnx _1395051678876251 = new DPST_1_1_ImplKnx(knxConnector, init__1395051678876251);

			// add existing translations
			if (translations.containsKey("P-0341-0_DI-2_M-0001_A-6102-01-A218_O-0_R-0")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_DI-2_M-0001_A-6102-01-A218_O-0_R-0")) {
					_1395051678876251.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}

			// set uri
			_1395051678876251.setHref(new Uri("/networks/office/datapoints/switch_status/1"));
			...
			if (groupAddresses.containsKey("P-0341-0_DI-10_M-0001_A-2413-01-B14F_O-7_R-41"))
				init__1395051678877252.setGroupAddress(
						new GroupAddress(groupAddresses.get("P-0341-0_DI-10_M-0001_A-2413-01-B14F_O-7_R-41")));

			init__1395051678877252.setDisplay("Brighter / Darker");

			init__1395051678877252.setDisplayName("Dimming outer right");

			init__1395051678877252.setName("P-0341-0_DI-10_M-0001_A-2413-01-B14F_O-7_R-41");

			init__1395051678877252.setReadable(false);
			init__1395051678877252.setWritable(true);

			// create datapoint
			DPST_3_7_ImplKnx _1395051678877252 = new DPST_3_7_ImplKnx(knxConnector, init__1395051678877252);

			// add existing translations
			if (translations.containsKey("P-0341-0_DI-10_M-0001_A-2413-01-B14F_O-7_R-41")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_DI-10_M-0001_A-2413-01-B14F_O-7_R-41")) {
					_1395051678877252.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}

			// set uri
			_1395051678877252.setHref(new Uri("/networks/office/datapoints/dimming_outer_right/1"));
			...
			if (groupAddresses.containsKey("P-0341-0_DI-2_M-0001_A-6102-01-A218_O-1_R-1"))
				init__1395051678877253.setGroupAddress(
						new GroupAddress(groupAddresses.get("P-0341-0_DI-2_M-0001_A-6102-01-A218_O-1_R-1")));

			init__1395051678877253.setDisplay("Brighter / Darker");

			init__1395051678877253.setDisplayName("Dimming");

			init__1395051678877253.setName("P-0341-0_DI-2_M-0001_A-6102-01-A218_O-1_R-1");

			init__1395051678877253.setReadable(false);
			init__1395051678877253.setWritable(true);

			// create datapoint
			DPST_3_7_ImplKnx _1395051678877253 = new DPST_3_7_ImplKnx(knxConnector, init__1395051678877253);

			// add existing translations
			if (translations.containsKey("P-0341-0_DI-2_M-0001_A-6102-01-A218_O-1_R-1")) {
				for (ArrayList<String> entry : translations.get("P-0341-0_DI-2_M-0001_A-6102-01-A218_O-1_R-1")) {
					_1395051678877253.addTranslation(entry.get(0), entry.get(1), entry.get(2));
				}
			}

			// set uri
			_1395051678877253.setHref(new Uri("/networks/office/datapoints/dimming/1"));
