...
public class PLSettings extends KNXMediumSettings {
	 ...
	 *            <code>domain.length</code> = 2, supplying <code>null</code>
	 *            defaults to the broadcast domain
	 * @param mediumPL132
	 *            <code>true</code> if communicating on PL132,
	 ...
	 * <p>
	 * The device address is initialized to 0.0.0 and domain address is set to
	 * broadcast domain.
	 * 
	 * @param mediumPL132
	 *            <code>true</code> if communicating on PL132,
	...
	/**
	 * Returns whether settings are for communication on PL132 medium or PL110
	 * medium.
	 * <p>
	 * 
