...
/**
 * Common service request structure, used to send requests over established
 * KNXnet/IP communication channels.
 * <p>
 * Such a service request is used for tunnel or device management connections.
 * It carries a cEMI frame containing the actual KNX frame data.<br>
...
public class ServiceRequest extends ServiceType {
	 ...
	 * 
	 * @param serviceType
	 *            service request type identifier describing the request in
	 *            <code>data</code>, 0 &lt;= type &lt;= 0xFFFF
	 * @param data
	 *            byte array containing a service request structure
	 * @param offset
	 *            start offset in bytes of request in <code>data</code>
	 * @param length
	 *            the length in bytes of the whole request contained in
	 *            <code>data</code>
	 * @throws KNXFormatException
	 *             if buffer is too short for request, on unsupported service
	 *             type or connection header structure
	 */
	 ...
	 * 
	 * @param serviceType
	 *            service request type identifier, 0 &lt;= type &lt;= 0xFFFF
	 * @param channelID
	 *            channel ID of communication this request belongs to, 0 &lt;=
	 *            id &lt;= 255
	 * @param seqNumber
	 *            the sending sequence number of the communication channel, 0
	 *            &lt;= number &lt;= 255
	 * @param frame
	 *            cEMI frame carried with the request
	 */
