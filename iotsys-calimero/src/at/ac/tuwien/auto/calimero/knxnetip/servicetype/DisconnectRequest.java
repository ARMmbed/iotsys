 ...
 * <p>
 * It is used to request the termination of a established logical connection
 * between a client and server, both control endpoints might send such
 * request.<br>
...
public class DisconnectRequest extends ServiceType {
	 ...
	 * 
	 * @param data
	 *            byte array containing a disconnect request structure
	 * @param offset
	 *            start offset of request in <code>data</code>
	 * @throws KNXFormatException
	 *             if no disconnect request was found or invalid structure
	 */
	...
	/**
	 * Creates a new disconnect request for the connection identified by the
	 * channel ID.
	 * <p>
	 * 
	 * @param channelID
	 *            communication channel ID uniquely identifying the connection
	 *            to close
	 * @param ctrlEndpoint
	 *            client control endpoint used for disconnect response
	 */
	...
	/**
	 * Returns the communication channel identifier of the connection being
	 * closed.
	 * <p>
	 * 
