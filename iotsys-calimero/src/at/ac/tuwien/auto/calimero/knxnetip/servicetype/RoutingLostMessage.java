 ...
 * <p>
 * The routing lost message is used to inform about the fact, that routing
 * messages were lost due to an overflow in the LAN-to-KNX queue, i.e. a router
 * receives more IP packets than it is able to deliver to the KNX network.<br>
...
public class RoutingLostMessage extends ServiceType {
	 ...
	 * 
	 * @param data
	 *            byte array containing a lost message indication structure
	 * @param offset
	 *            start offset of indication in <code>data</code>
	 * @throws KNXFormatException
	 *             if buffer is too short for routing lost message indication or
	 *             lost message info has wrong size
	 */
	 ...
	 * 
	 * @param lostMessages
	 *            number of KNXnet/IP routing messages lost
	 * @param deviceState
	 *            router device state, the router KNX property in object type
	 *            11, PID 69
	 */
	...
	/**
	 * Returns the router device state, i.e. the property referred to by PID 69
	 * of object type 11 in the KNX property table.
	 * <p>
	 * 
