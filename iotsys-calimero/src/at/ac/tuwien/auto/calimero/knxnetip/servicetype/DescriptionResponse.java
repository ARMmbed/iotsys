 ...
 * <p>
 * Such response is sent by a server in reply to a description request from a
 * client.<br>
 * A response contains a device description information block (DIB) and a
 * supported service families DIB. Optionally, it might contain an additional
 * DIB with other information. Such optional DIB is only paid attention in case
 * of type manufacturer data DIB, otherwise it is ignored.
 * <p>
...
public class DescriptionResponse extends ServiceType {
	 ...
	 * 
	 * @param data
	 *            byte array containing a description response structure
	 * @param offset
	 *            start offset of response in <code>data</code>
	 * @throws KNXFormatException
	 *             if no description response was found or invalid structure of
	 *             DIBs carried in the response
	 */
	...
	/**
	 * Creates a new description response containing a device DIB and a
	...
	/**
	 * Creates a new description response containing a device DIB, a supported
	 * service families DIB and a manufacturer DIB.
	 * <p>
	 * 
	 * @param device
	 *            device description
	...
	/**
	 * Returns the device description information block contained in the
	 * response.
	 * <p>
	 * 
	 * @return a device DIB
	...
	/**
	 * Returns the manufacturer data description information block optionally
	 * contained in the response.
	 * <p>
	 * The manufacturer data is not a mandatory part of a description response.
	 * It is only available, if the optional DIB information of a response
	 * matches this DIB type.<br>
	 * 
