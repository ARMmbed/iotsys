...
/**
 * Common KNXnet/IP acknowledge structure, used to send acknowledges over
 * established KNXnet/IP communication channels.
 * <p>
 * An acknowledge is sent in reply to a service request, to confirm the
 * reception of the request over the IP communication channel. Note, it doesn't
 * tell anything about delivery on the KNX network.
 * 
...
public class ServiceAck extends ServiceType {
	 ...
	 * 
	 * @param serviceType
	 *            service acknowledge type identifier describing the acknowledge
	 *            in <code>data</code>, 0 &lt;= type &lt;= 0xFFFF
	 * @param data
	 *            byte array containing a service acknowledge structure
	 * @param offset
	 *            start offset of acknowledge in <code>data</code>
	 * @throws KNXFormatException
	 *             if buffer is too short for acknowledge, on unsupported
	 ...
	 * 
	 * @param serviceType
	 *            service acknowledge type identifier, 0 &lt;= type &lt;= 0xFFFF
	 * @param channelID
	 *            channel ID of communication this ack belongs to, 0 &lt;= id
	 *            &lt;= 255
	 * @param seqNumber
	 *            the sequence number of the communication channel, value
	 *            corresponds to the received request, 0 &lt;= number &lt;= 255
	 * @param status
	 *            status code to the corresponding request, 0 &lt;= status &lt;=
	 *            255
	 */
	...
	/**
	 * Returns the communication channel identifier associated with the
	 * acknowledge.
	 * <p>
	 * 
	...
	/**
	 * Returns the status code of the acknowledge, regarding the corresponding
	 * request.
	 * <p>
	 * 
