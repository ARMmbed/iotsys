 ...
 * properties.
 * <p>
 * A property adapter is created for one communication partner (KNX device,
 * KNXnet/IP router).<br>
 * If {@link #close()} is called by a user on an open adapter, all methods which
 * do interface object property access are allowed to throw
...
public interface PropertyAdapter {
	 ...
	 * @throws KNXException
	 *             on error setting the interface object property
	 * @throws KNXIllegalStateException
	 *             if adapter was already closed
	 */
	void setProperty(int objIndex, int pid, int start, int elements, byte[] data) throws KNXException;
	 ...
	 * @throws KNXException
	 *             on error getting the interface object property
	 * @throws KNXIllegalStateException
	 *             if adapter was already closed
	 */
	byte[] getProperty(int objIndex, int pid, int start, int elements) throws KNXException;

	/**
	 * Reads the description of a property of an interface object.
	 * <p>
	 * The property description layout is according the application layer
	 ...
	 * @throws KNXException
	 *             on error getting the property description
	 * @throws KNXIllegalStateException
	 *             if adapter was already closed
	 */
	...
	/**
	 * Returns whether this adapter can be used for property access and is not
	 * closed.
	 * 
	 ...
	 * Closes the adapter.
	 * <p>
	 * Depending on the adapter, necessary steps to terminate a connection might
	 * be done and owned resources will be freed.<br>
