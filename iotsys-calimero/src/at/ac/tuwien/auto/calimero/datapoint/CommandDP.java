 ...
 * <p>
 * Interaction of command based datapoints is done solely with events (i.e.
 * "commands"), not telling anything about a datapoint state.
 * 
 * @author B. Malinowsky
 */
public class CommandDP extends Datapoint {
	...
	/**
	 * Creates a new command based datapoint with a name, and specifies
	 * datapoint translation type.
	 * <p>
	 * 
	 * @param main
	 *            the group address used to identify this datapoint
	...
	public CommandDP(XMLReader r) throws KNXMLException {
		super(r);
		if (isStateBased())
			throw new KNXMLException("no command based KNX datapoint element", null, r.getLineNumber());
		doLoad(r);
	}
