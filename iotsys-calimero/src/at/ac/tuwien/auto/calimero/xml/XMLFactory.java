 ...
 * <p>
 * A {@link XMLWriter} and {@link XMLReader} is created using its default
 * constructor, i.e. every implementation is required to supply such a
 * constructor.<br>
 * By default, the factory creates instances of types located in the
 * <code>def</code> sub package.<br>
 * The factory uses an {@link EntityResolver} to resolve XML resources.
 * <p>
 * Note that for now only one default XML reader/writer is available in this
 * factory, and therefore can't be changed.
 * 
 * @author B. Malinowsky
 */
public final class XMLFactory {
	// if we have more than one reader/writer implementation or wrappers for
	// other
	...
	/**
	 * Creates a {@link XMLReader} to read the XML resource located by the
	 * specified identifier.
	 * <p>
	 * On closing the created XML reader, the {@link Reader} set as input for
	 * the XML reader will get closed as well.
	 * 
	 * @param systemID
	 *            location identifier of the XML resource
	 * @return XML reader
	 * @throws KNXMLException
	 *             if creation of the reader failed or XML resource can't be
	 *             resolved
	 */
	...
	/**
	 * Creates a {@link XMLWriter} to write into the XML resource located by the
	 * specified identifier.
	 * <p>
	 * 
	 * @param systemID
	 ...
	 * @return XML writer
	 * @throws KNXMLException
	 *             if creation of the writer failed or XML resource can't be
	 *             resolved
	 */
