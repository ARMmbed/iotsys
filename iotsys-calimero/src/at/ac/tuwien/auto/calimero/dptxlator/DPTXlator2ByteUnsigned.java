...
/**
 * Translator for KNX DPTs with main number 7, type <b>2 byte unsigned
 * value</b>.
 * <p>
 * The KNX data type width is 2 bytes.<br>
 * The default return value after creation is 0.
 * <p>
 * Supplied string value items might be formatted using decimal, hexadecimal,
...
public class DPTXlator2ByteUnsigned extends DPTXlator {
	/**
	 * DPT ID 7.001, Unsigned count; values from <b>0</b> to <b>65535</b>
	 * pulses.
	 * <p>
	 */
	...
	/**
	 * DPT ID 7.003, Time period (resolution 10 ms); values from <b>0</b> to
	 * <b>655350</b> ms.
	 * <p>
	 */
	...
	/**
	 * DPT ID 7.004, Time period (resolution 100 ms); values from <b>0</b> to
	 * <b>6553500</b> ms.
	 * <p>
	 */
	public static final DPT DPT_TIMEPERIOD_100 = new DPT("7.004", "Time period (resolution 100 ms)", "0", "6553500",
			"ms");

	/**
	 * DPT ID 7.005, Time period in seconds; values from <b>0</b> to
	 * <b>65535</b> s (~18,2 hours).
	 * <p>
	 */
	public static final DPT DPT_TIMEPERIOD_SEC = new DPT("7.005", "Time period in seconds", "0", "65535", "s");

	/**
	 * DPT ID 7.006, Time period in minutes; values from <b>0</b> to
	 * <b>65535</b> min (~45,5 days).
	 * <p>
	 */
	public static final DPT DPT_TIMEPERIOD_MIN = new DPT("7.006", "Time period in minutes", "0", "65535", "min");

	/**
	 * DPT ID 7.007, Time period in hours; values from <b>0</b> to <b>65535</b>
	 * h (~7,4 years).
	 * <p>
	 */
	...
	/**
	 * DPT ID 7.010, Interface object property ID; values from <b>0</b> to
	 * <b>65535</b>.
	 * <p>
	 */
	...
	/**
	 * DPT ID 7.012, Electrical current; values from <b>0</b> to <b>65535</b>
	 * mA.
	 * <p>
	 * A value of 0 indicates no bus power supply functionality available, 1 to
	 * 65535 is the current in mA.
	 */
	 ...
	 * <p>
	 * Note: the unit of measure symbol used here is "lx", and not "Lux" as
	 * originally proposed for this DPT.
	 */
	 ...
	 * <p>
	 * A value of DPT {@link #DPT_TIMEPERIOD_10} or {@link #DPT_TIMEPERIOD_100}
	 * is expected in unit millisecond, i.e. a value of DPT_TIMEPERIOD_10 gets
	 * divided by 10, a value of DPT_TIMEPERIOD_100 by 100. The result is
	 * rounded to the nearest representable value (with 0.5 rounded up). On any
	 * other DPT the value is expected according to its unit.
	 * 
	 * @param value
	 *            unsigned value, 0 &lt;= value &lt;= max, with
	 *            <ul>
	 ...
	 *            </ul>
	 * @throws KNXFormatException
	 *             on input value out of range for DPT
	 * @see #getType()
	 */
	 ...
	 * <p>
	 * A value of DPT {@link #DPT_TIMEPERIOD_10} or {@link #DPT_TIMEPERIOD_100}
	 * is returned in unit millisecond, i.e. a KNX DPT_TIMEPERIOD_10 data value
	 * is multiplied with 10, DPT_TIMEPERIOD_100 with 100.<br>
	 ...
	 * {@link #DPT_TIMEPERIOD}, {@link #DPT_TIMEPERIOD_10},
	 * {@link #DPT_TIMEPERIOD_100} {@link #DPT_TIMEPERIOD_SEC},
	 * {@link #DPT_TIMEPERIOD_MIN} and {@link #DPT_TIMEPERIOD_HOURS}. The
	 * milliseconds are converted to the unit of the set DPT, with the result
	 * rounded to the nearest representable value (with 0.5 rounded up).<br>
	 * On any other DPT, the input is treated equal to {@link #setValue(int)}.
	 * 
	 * @param milliseconds
	 *            the value in milliseconds, 0 &lt;= <code>milliseconds</code>
	 * @throws KNXFormatException
	 *             on milliseconds out of range for DPT
	 */
	...
	private short[] toDPT(long ms) throws KNXFormatException {
		...
		if (ms < 0)
			throw logThrow(LogLevel.WARN, "negative input value " + Long.toString(ms), null, Long.toString(ms));
		long v = ms;
	...
	private int getLimit(String limit) throws KNXFormatException {
		try {
			...
			final int upper = dpt.equals(DPT_TIMEPERIOD_10) ? 655350 : dpt.equals(DPT_TIMEPERIOD_100) ? 6553500 : 65535;
			if (i >= 0 && i <= upper)
				return i;
		} catch (final NumberFormatException e) {
		}
