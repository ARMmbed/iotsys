...
/**
 * Translator for KNX DPTs with main number 12, type <b>4 byte unsigned
 * value</b>.
 * <p>
...
public class DPTXlator4ByteUnsigned extends DPTXlator {
	/**
	 * DPT ID 12.001, Unsigned count; values from <b>0</b> to <b>4294967295</b>
	 * counter pulses.
	 * <p>
	 */
	public static final DPT DPT_VALUE_4_UCOUNT = new DPT("12.001", "Unsigned count", "0", "4294967295",
			"counter pulses");
	 ...
	 * 
	 * @param value
	 *            unsigned value, 0 &lt;= value &lt;= 0xFFFFFFFF
	 * @throws KNXFormatException
	...
	private short[] toDPT(long value, short[] dst, int index) throws KNXFormatException {
		if (value < 0 || value > 0xFFFFFFFFL)
			throw logThrow(LogLevel.WARN, "translation error for " + value, "input value out of range",
					Long.toString(value));
		final int i = 4 * index;
