 ...
 * Note, that {@link #DPT_SCALING} and {@link #DPT_ANGLE} are scaled
 * representations, which means the DPT's value ranges [0..100] respectively
 * [0..360] are mapped to the 8 Bit KNX value range [0..255], with mapped values
 * rounded to the next nearest integer value.
 * <p>
 * In value methods expecting string items, the item might be formatted using
 * decimal, hexadecimal, and octal numbers, distinguished by using these
 * prefixes:
...
public class DPTXlator8BitUnsigned extends DPTXlator {
	 ...
	 * <p>
	 * <b>This is a preliminary datapoint type, still in state "to be
	 * defined".</b>
	 */
	public static final DPT DPT_DECIMALFACTOR = new DPT("5.005", "Decimal factor", "0", "255", "ratio");

	/**
	 * DPT ID 5.010, Value 1 unsigned count; values from <b>0</b> to <b>255</b>
	 * counter pulses.
	 * <p>
	 */
	...
	/**
	 * Sets one new translation item from an unsigned unscaled value, replacing
	 * any old items.
	 * <p>
	 * No scaling is performed during translation, the value is equal to the raw
	 * KNX data.
	 * 
	 * @param unscaled
	 *            unscaled unsigned value, 0 &lt;= <code>unscaled</code> &lt;=
	 *            255, the higher bytes are ignored
	 */
