 ...
 * -671088.64 to +670760.96. DPTs adjust the usable range to reasonable limits
 * for its values, the translator will check and enforce those DPT specific
 * limits in all methods working with java values (e.g.
 * {@link #setValue(float)}). Data methods for KNX data (e.g.
 ...
 * Note, that the floating type structure specified by this data type isn't
 * really precise, especially for bigger floating numbers, so you have to expect
 * certain rounding deviations.
 * 
 * @author B. Malinowsky
 */
public class DPTXlator2ByteFloat extends DPTXlator {
	/**
	 * DPT ID 9.001, Temperature; values from <b>-273</b> to <b>+670760</b>
	 * \u00b0C.
	 * <p>
	 */
	 ...
	 * <p>
	 */
	public static final DPT DPT_TEMPERATURE_DIFFERENCE = new DPT("9.002", "Temperature difference", "-670760",
			"+670760", "K");
	 ...
	 * <p>
	 */
	public static final DPT DPT_TEMPERATURE_GRADIENT = new DPT("9.003", "Temperature gradient", "-670760", "+670760",
			"K/h");

	/**
	 * DPT ID 9.004, Intensity of light (Lux); values from <b>0</b> to
	 * <b>+670760</b> lx.
	 * <p>
	...
	/**
	 * DPT ID 9.011, Time difference in milliseconds; value range
	 * <b>+/-670760</b> ms.
	 * <p>
	 */
	...
	/**
	 * DPT ID 9.022, Power density; value range <b>+/-670760</b>
	 * W/m<sup>2</sup>.
	 * <p>
	 */
