 ...
 * <p>
 * The implementation of this API contains platform dependent code. It is used
 * as a fallback to enable serial communication on a RS-232 port in case default
...
class SerialCom extends LibraryAdapter {
	// Notes:
	// Using CDC ME connector/comm interfaces and subtype them in Calimero
	// prevents
	...
	static final class Timeouts {
		...
		Timeouts(int readInterval, int readTotalMultiplier, int readTotalConstant, int writeTotalMultiplier,
