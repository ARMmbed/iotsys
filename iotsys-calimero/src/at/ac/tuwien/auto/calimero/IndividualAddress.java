 ...
 * <p>
 * An individual address is built up from 3 levels: area.line.device (4.4.8
 * bits) with separator of type '.' or '/'.<br>
...
public class IndividualAddress extends KNXAddress {
	...
	/**
	 * Creates a KNX individual address from the 3-level notation area-, line-
	 * and device-address.
	 * <p>
	 * 
	 * @param area
	 *            area address value, in the range 0 <= value <= 0xF
	 * @param line
	 *            line address value, in the range 0 <= value <= 0xF
	 * @param device
	 *            device address value, in the range 0 <= value <= 0xFF
	 */
	 ...
	 * representation.
	 * <p>
	 * The address consists of 3 levels (see class header specification).
	 * Allowed separators are '.' or '/', mutually exclusive.
	 * 
	 * @param address
	 *            string containing the KNX address
	 * @throws KNXFormatException
	 *             on unknown address type, wrong address syntax, address values
	 ...
	 * <p>
	 * The area address consists of the 4 most significant Bits in the address
	 * field.
	 * 
	 ...
	 * <p>
	 * The line address consists of 4 bits, starting with bit 8 to 11 in the
	 * address field.
	 * 
	...
	/**
	 * Returns the address as a string using the 3-level "area.line.device"
	 * notation.
	 * <p>
	 * 
	 ...
	 *         contains the same address, <code>false</code> otherwise
	 */
