...
public enum VIF_Extension_FD_Mask {
	// Currency Units
	CURRENCY_CREDIT(0x03), // E000 00nn Credit of 10 nn-3 of the nominal local
							// legal currency units
	CURRENCY_DEBIT(0x07), // E000 01nn Debit of 10 nn-3 of the nominal local
							// legal currency units
	...
	PARAMETER_SET_ID(0x0B), // E000 1011 Parameter set identification Enhanced
							// Identification
	...
	// E010 1010 Reserved
	// E010 1011 Reserved
	DURATION_SINCE_LAST_READOUT(0x2F), // E010 11nn Duration since last readout
										// [sec(s)..day(s)]
	// Enhanced tarif management
	START_OF_TARIFF(0x30), // E011 0000 Start (date/time) of tariff
	DURATION_OF_TARIFF(0x3), // E011 00nn Duration of tariff (nn=01 ..11: min to
								// days)
	...
	DURATION_SINCE_LAST_CUMULATION(0x6B), // E110 10pp Duration since last
											// cumulation [hour(s)..years(s)]
	OPERATING_TIME_BATTERY(0x6F), // E110 11pp Operating time battery
									// [hour(s)..years(s)]
	DATEAND_TIME_OF_BATTERY_CHANGE(0x70); // E111 0000 Date and time of battery
											// change
