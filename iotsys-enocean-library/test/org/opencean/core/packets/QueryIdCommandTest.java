...
public class QueryIdCommandTest {
	...
	private static final byte[] testPayload = new byte[] { (byte) 0x00, (byte) 0x04, (byte) 0x07, (byte) 0xFF,
			(byte) 0xFF, (byte) 0xFF, (byte) 0xFF, (byte) 0xFF, (byte) 0x00, (byte) 0x00, 0x00, (byte) 0x00, 0x65 };

	@Test
	public void testToBytes() {
		byte[] expected = new ByteArray().addByte(BasicPacket.SYNC_BYTE).addBytes(testHeader).addBytes(testPayload)
				.getArray();
