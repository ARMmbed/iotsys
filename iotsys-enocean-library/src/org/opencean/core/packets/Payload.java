...
public class Payload {
	...
	public void checkCrc8() {
		if (calculateCrc8() != crc8) {
			throw new RuntimeException(
					"Payload CRC 8 is not correct! Expected " + calculateCrc8() + ", but received " + crc8);
		}
	}
	...
	public String toString() {
		return "Payload: " + "data=" + new ByteArray(getData()) + ", optionaldata=" + new ByteArray(getOptionalData())
				+ ", crc8d=" + crc8;
	}
