...
public class RadioPacket4BS extends RadioPacket {
	...
	public RadioPacket4BS(byte[] data, int senderId, byte status, byte subTelNum, int destinationId, byte dBm,
			byte securityLevel) {
	...
	public String toString() {
		return super.toString() + String.format(", [db0=%02X, db1=%02X, db2=%02X, db3=%02X, teachIn=%s]", db0, db1, db2,
				db3, isTeachInMode());
	}
}
