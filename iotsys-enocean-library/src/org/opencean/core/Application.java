...
public class Application {
	...
	public static void main(String[] args) throws Exception {
		...
		// for(int i=0;i<=20;i++){
		// BasicPacket packet = change.changeState((i%2==0)?ON:OFF, enId,
		// EEPId.EEP_F6_02_01.toString(),rlc.getByte());
		// logger.info("Send packet: RLC " +
		// Integer.toHexString(rlc.readValue()) + " Packet: " +
		// packet.toString());
		// esp3Host.sendRadio(packet);
		// Thread.sleep(500);
		// }
		...
		// RadioPacket radio;
		//
		// byte dataOn[] = {(byte) 0xF6, (byte) 0x50, (byte) 0x00, (byte) 0x25,
		// (byte) 0xA2, (byte) 0xDC, (byte) 0x30};
		// byte optDataOn[] = {(byte) 0x01, (byte) 0xFF, (byte) 0xFF, (byte)
		// 0xFF, (byte) 0xFF, (byte) 0x32, (byte) 0x00};
		// byte dataOff[] = {(byte) 0xF6, (byte) 0x70, (byte) 0x00, (byte) 0x25,
		// (byte) 0xA2, (byte) 0xDC, (byte) 0x30};
		// byte optDataOff[] = {(byte) 0x01, (byte) 0xFF, (byte) 0xFF, (byte)
		// 0xFF, (byte) 0xFF, (byte) 0x3A, (byte) 0x00};
		//
		// radio = new RadioPacket(dataOff, (byte) 0x01, 0xFFFFFFFF, (byte)
		// 0x51, (byte) 0x00);
		//
		...
		// radio4BS = new RadioPacket4BS(data, 0xAA25A2DC, (byte) 0x00, (byte)
		// 0x03, 0x00857A08, (byte) 0xFF, (byte) 0x00);
		//
		// packet = radio4BS;
		// logger.info("Send packet: " + packet.toString());
		// esp3Host.sendRadio(packet);
		...
		// p.initCRC8();
		// BasicPacket packet = new RadioPacket((new RawPacket(new
		// Header((byte)0x01, (short)0x07, (byte)0x07), p)));
		// esp3Host.sendRadio(packet);
