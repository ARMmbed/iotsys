...
public class VOCSensor implements EEPParser {
	...
	private static final Map<Integer, Float> SCALE_MULTIPLIER_MAP = Collections
	...
	private static final Map<Integer, String> IDENTIFICATION_MAP = Collections
	...
	public Map<EnoceanParameterAddress, Value> parsePacket(BasicPacket packet) {
		...
		if (packet instanceof RadioPacket4BS) {
			...
			map.put(new EnoceanParameterAddress(radioPacket4BS.getSenderId(),
					Parameter.VOC_CONCENTRATION + "_" + this.currentValueIdentification),
					new NumberWithUnit(Unit.PPB, this.currentValueConcentration * this.currentValueScaleMultiplier));
		}
		return map;
	}
