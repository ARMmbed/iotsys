		...
		try {
			while (true) {
				...
				if (response.getApiId() == ApiId.ZNET_IO_SAMPLE_RESPONSE) {
					...
					// double intensityPercentualValue = (ioSample.getAnalog0()
					// - (ioSample.getAnalog0()-ioSample.getAnalog1()));
					...
					/*
					 * System.err.println("Value first input pin Temperature: "
					 * +ioSample.getAnalog2());
					 * System.err.println("Value first input pin: "+ioSample.
					 * getAnalog3());
					 * 
					 * System.err.println("Response from: " +addressArray);
					 * System.err.
					 * println("Analog D0 (pin 20) 10-bit reading is " +
					 * ioSample.getAnalog0());
					 * System.err.println("Digital D4 (pin 11) is " +
					 * (ioSample.isD4On() ? "on" : "off"));
					 */
				}
			}
