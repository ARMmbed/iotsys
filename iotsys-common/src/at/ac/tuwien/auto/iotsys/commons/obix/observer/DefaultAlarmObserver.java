...
/**
 * The Default Alarm Observer generates Alarms that are reported to the default
 * Alarm Subject
 */
public class DefaultAlarmObserver extends AlarmObserver {
	 ...
	 *            the alarm condition to watch for
	 * @param stateful
	 *            <code>true</code> if stateful alarms should be generated,
	 *            <code>false</code> otherwise
	 * @param acked
	 *            <code>true</code> if acknowledgeable alarms should be
	...
	/**
	 * A Observer that observes an alarm source for an alarm condition and
	 * reports generated Alarms to the default Alarm Subject. By default,
	 * generates stateful, acknowledgeable alarms.
	 * 
	 * @param alarmCondition
	 *            the alarm condition to watch for
	 */
