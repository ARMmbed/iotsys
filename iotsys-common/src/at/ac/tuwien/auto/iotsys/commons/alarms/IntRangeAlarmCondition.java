...
/**
 * An IntRangeAlarmCondition checks if the value of an Int is inside an allowed
 * range.
 */
public class IntRangeAlarmCondition extends AlarmCondition {
	 ...
	 * 
	 * @param min
	 *            The minimum allowed value. If <code>null</code>, there is no
	 *            lower bound .
	 * @param max
	 *            The maximum allowed value. If <code>null</code>, there is no
	 *            upper bound.
	 */
