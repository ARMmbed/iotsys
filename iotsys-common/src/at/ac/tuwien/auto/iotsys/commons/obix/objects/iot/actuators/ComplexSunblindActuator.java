...
public interface ComplexSunblindActuator extends Actuator {
	...
	public static final String POSITION_BLIND_HIGH_CONTRACT = "<int name='" + POSITION_BLIND_HIGH_CONTRACT_NAME
			+ "' href='" + POSITION_BLIND_HIGH_CONTRACT_HREF + "' val='0'/>";
	...
	public static final String POSITION_SLAT_CONTRACT = "<int name='" + POSITION_SLAT_CONTRACT_NAME + "' href='"
			+ POSITION_SLAT_CONTRACT_HREF + "' val='0'/>";
