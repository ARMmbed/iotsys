...
public class BacnetDeviceFactory {
	...
	public static Obj createDevice(BACnetConnector bacnetConnector, RemoteDevice device,
			ObjectIdentifier objIdentifier) {
		BacnetDataPointInfo bacnetDataPointInfo = new BacnetDataPointInfo(device.getInstanceNumber(), objIdentifier,
