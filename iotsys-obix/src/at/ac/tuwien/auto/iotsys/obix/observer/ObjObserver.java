...
/**
 * Observes the state changes of an obix object. Holds a history of the changes
 * until the events are polled or the max number of elements is exceeded.
 * 
 * This class also acts as a singleton subject, in order to allow CoAP updates
 * on observed resources.
 *
 */
