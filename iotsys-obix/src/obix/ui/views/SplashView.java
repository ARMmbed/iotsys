...
public class SplashView extends View {
	...
	public SplashView(Shell shell) {
		...
		String javaVer = System.getProperty("java.vm.name") + " " + System.getProperty("java.vm.version") + " ("
				+ System.getProperty("java.home") + ")";

		JLabel img = new JLabel(logo, JLabel.CENTER);
		JLabel line1 = new JLabel("Java Obix Toolkit v1.0.0", JLabel.CENTER);
		JLabel line2 = new JLabel("This software is Public Domain - do whatever the heck you want with it!",
				JLabel.CENTER);
