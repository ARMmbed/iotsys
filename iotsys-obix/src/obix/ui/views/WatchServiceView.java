 ...
 */
public class WatchServiceView extends View {
	...
	static class Row {
		...
		public Object get(int col) {
			...
			case 2:
				return "" + watch.size();
			case 3:
				return Utils.duration(watch.getLease());
			case 4:
				return Utils.duration(watch.getPollPeriod());
			case 5:
				return Utils.millisAgo(watch.lastPollAttempt());
			case 6:
				return Utils.millisAgo(watch.lastPollSuccess());
			default:
				return "?";
			}
		}
