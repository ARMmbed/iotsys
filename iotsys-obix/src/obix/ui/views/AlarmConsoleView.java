 ...
 */
public class AlarmConsoleView extends View {
	...
	public void changed(Obj obj) {
		/*
		 * System.out.println("AlarmConsoleView.changed"); obj.dump();
		 */
	...
	class Model extends AbstractTableModel {
		...
		public Object getValueAt(int row, int col) {
			return ((Row) rows.get(row)).format(col);
		}
	}
	...
	static class Row {
		...
		public Object get(int col) {
			switch (col) {
			case 0:
				return alarm.get("timestamp");
			case 1:
				return alarm.get("source");
			case 2:
				return alarm.get("normalTimestamp");
			case 3:
				return alarm.get("ackTimestamp");
			case 4:
				return alarm.get("ackUser");
			case 5:
				return alarm.get("alarmValue");
			case 6:
				return alarm.getIs();
			default:
				return "?";
