...
/**
 * The HighlightedImageFactory converts a color image to one that appears
 * highlighted by applying a red filter to the image.
 *
 * @author Andy Frank
 * @creation 16 Jul 01
 * @version $Revision$ $Date$
 */
public class HighlightedImageFactory extends RGBImageFilter {
