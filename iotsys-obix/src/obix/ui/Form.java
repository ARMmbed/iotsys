...
/**
 * Form is a simple swing utility to display a set of labels and textfields to
 * edit a Java class's public fields using reflection.
 *
 * @author Brian Frank
 * @creation 13 Sept 05
...
public class Form extends JPanel {
	...
	/**
	 * Prompt the user with a dialog to edit the specified target fields. Return
