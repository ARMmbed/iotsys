...
public class Utils {
	...
	/**
	 * Sync an image since AWT will async load an image even if given the entire
	 * image file as a byte array.
	 */
	...
	/**
	 * Translate a programatic name to a friendly name. This is done based on
	 * standard identifier capitalization. So the string "fooBar" would be
	 * translated as "Foo Bar".
	 */
	...
	/**
	 * Get a string description of how long ago the specified millis occurred.
	 */
