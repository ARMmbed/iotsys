...
/**
 * The ChunkedInputStream handles reading a stream of bytes using the chunked
 * transfer encoding.
 *
 * @author John Sublett
...
public class ChunkedInputStream extends InputStream {
	...
	/**
	 * If the specified character is equal to the target return the next
	 * character from the input, otherwise throw an IOException.
	 */
	...
	/**
	 * If the specified character is equal to the target return, otherwise throw
	 * an IOException.
	 */
