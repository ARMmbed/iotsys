...
/**
 * The HttpDateFormat class handles generating formatted date header field
 * values from a long or date. It also handles parsing a string date into a long
 * value representing the date and time. Parsed strings must be in a standard
 * HTTP date and time format using GMT. Date strings are generated in the RFC
 * 1123 format.
 *
 * @author John Sublett
...
public class HttpDateFormat {
	/**
	 * Format the specified Date into a RFC 1123 date string using the specified
	 * character to separate the elements of the date.
	 */
	...
	/**
	 * Format the specified date and time into a RFC 1123 date string.
	 */
	...
	/**
	 * Format the specified Date into a RFC 1123 date string.
	 */
	...
	/**
	 * Format the specified DateTimeInfo into a string with the RFC 1123 date
	 * time format.
	 */
	...
	/**
	 * Parse the specified date string and compute the date and time as a long.
	 */
	...
	/**
	 * Get the weekday index for the specified weekday string. Valid indexes are
	 * Calendar.SUNDAY - Calendar.SATURDAY. -1 is returned if the string is not
	 * recognized as a weekday.
	 */
	...
	/**
	 * Get an integer value from the specified day of month string. If the
	 * string does not represent a day of the month (i.e. it's not a number) -1
	 * is returned.
	 */
	...
	/**
	 * Get the month index for the specified month string. Valid indexes are
	 * Calendar.JANUARY - Calendar.DECEMBER. If the specified string is not
	 * recognized as a month, -1 is returned.
	 */
	...
	/**
	 * Encapsulates the elements of a date. Used during parsing.
	 */
