...
/**
 * HttpConnection allows client applications to submit requests to an HTTP
 * server.
 *
 * @author John Sublett
...
public class HttpConnection {
	 ...
	 *            The content buffer.
	 */
	public static int post(String hostname, int port, String uri, String contentType, byte[] buf) throws IOException {
	...
	/**
	 * Set the SO_TIMEOUT option on the connection. If this is set to 0 or never
	...
	public int getTimeout() {
		try {
			...
			System.out.println("Exception in getTimeout:" + e);
		}
		return timeout;
	}

	/**
	 * Get whether or not this connection should automatically follow redirects.
	 */
	...
	/**
	 * Get the URI for the first resource retrieved with this connection.
	 */
	...
	/**
	 * Set the request method for this connection. The value is a string
	 * indicating the HTTP request type (e.g. GET, POST, HEAD, etc.). Constants
	 * for common values are defined on the class.
	 */
	...
	/**
	 * Set the specified request header field to the specified value.
	 */
	...
	/**
	 * Remove the request header field with the specified name.
	 */
	...
	/**
	 * Set whether or not this connection should automatically follow redirects.
	 */
	...
	/**
	 * Open the connection. If doAuthenticate is true, authentication requests
	 * will result in an automatic retry using the userName and password.
	 */
	...
	// public synchronized int put(String uri, String contentType, long
	// contentLength, InputStream contents)
	public synchronized int put(String uri, String contentType, byte[] contents) throws IOException {
	...
	/**
	 * Read the specified number of bytes off the given input stream to the
	 * specified output stream. This does not close either the input or output
	 * stream.
	 */
	 ...
	 */
	/* private */ int readResponse(InputStream in) throws IOException {
	...
	public InputStream getInputStream() throws IOException {
		...
		if ((transferEncoding != null) && transferEncoding.equalsIgnoreCase(Http.TRANSFER_CHUNKED))
	...
	/**
	 * Should this connection be closed after a single request?
	 */
	...
	public String dumpResponseHeader() {
		...
		while (e.hasMoreElements()) {
			...
			sbuf.append("   ").append(key).append(": ").append(responseHeaderFields.get(key)).append('\n');
		}
	...
	/**
	 * Make sure the returned status code is what was expected. If the actual
	 * status is unexpected, the connection is closed and an HttpException is
	 * thrown.
	 */
	...
	/**
	 * The StatusLine handles parsing of the HTTP response status line.
	 */
