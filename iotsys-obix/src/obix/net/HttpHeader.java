...
public class HttpHeader {
	...
	/**
	 * Get the date value for the specified field. If the field does not exist,
	 * -1 is returned. If the value cannot be converted to a date an
	...
	/**
	 * Does the header contain the specified field with the specified value?
	 * Both the name and value comparisons are case insensitive.
	 */
	 ...
	 *
	 * @param out
	 *            The output target for the header fields.
	 * @param trace
	 *            The trace buffer for the header fields. This may be null if no
	 *            tracing is required.
	 */
	...
	/**
	 * Let subclasses write any fields that have special handling (like
	 * cookies).
	 */
	...
	/**
	 * Parse a field value. The result is the input string or an array of
	 * strings resulting from a comma-separated input value.
	 */
	...
	/**
	 * Let subclasses append any fields that require special handling (like
	 * cookies).
	 */
