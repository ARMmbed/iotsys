...
/**
 * The ChunkedOutputStream handles writing a stream of bytes using the chunked
 * transfer encoding.
 *
 * @author John Sublett
...
public class ChunkedOutputStream extends OutputStream {
	 ...
	 *
	 * @param out
	 *            the output stream on which this one is being built
	 * @param maxChunkSize
	 *            the maximum number of bytes for a single chunk in the encoding
	 */
	...
	/**
	 * Set the value for an entity header field to appear in the footer.
	 */
	...
	/**
	 * Complete the chunked response. This does not close the internal output
	 * stream as it may be needed for subsequent requests. Writing to the stream
	 * after a close will throw an IOException.
	 */
