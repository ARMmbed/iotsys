 ...
 */
public class BatchIn extends List {
	 ...
	 * new object containing the server's result. Note that the Obj passed in
	 * must not have its 'name' attribute set, as this method must set the name
	 * to 'in', as required by the obix:Write contract.
	 */
	 ...
	 * the output parameter. Note that the Obj passed in must not have its
	 * 'name' attribute set, as this method must set the name to 'in', as
	...
	/**
	 * Commit this batch of requests to the server and return the BatchOut
	 * response.
	 */
	public List commit() throws Exception {
		/*
		 * System.out.println("====== BATCH.commit========>"); dump();
