...
public class BinObixEncoder extends DataOutputStream {
	...
	/**
	 * Encode the specified obj to an in memory byte array using localized
	 * strings.
	 */
	...
	private Node toNode(Obj obj, boolean markTailMore, String language) {
		...
		if (obj.getDisplayName() != null)
			tail = new StrNode(tail, BinObix.DISPLAY_NAME,
					obj.getTranslation(language, TranslationAttribute.displayName));
		if (obj.getIcon() != null)
