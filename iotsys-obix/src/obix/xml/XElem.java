...
public class XElem extends XContent {
	...
	/**
	 * Return <code>ns().prefix()</code> or null if no namespace is defined for
	 * this element.
	 */
	 ...
	 * or is in the default namespace return the local name. Otherwise return
	 * "<prefix>:<name>".
	 */
	 ...
	 * throw an XException. If the value cannot be parsed as "true" or "false"
	 * then throw an XException.
	 */
	 ...
	 * throw an XException. If the value cannot be parsed then throw an
	 * XException.
	 */
	 ...
	 * given def value. If the value cannot be parsed then throw an XException.
	 */
