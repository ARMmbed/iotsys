...
public class XParser {
	...
	/**
	 * Get the current element if <code>type()</code> is ELEM_START or ELEM_END.
	 * If <code>type()</code> is TEXT then this is the parent element of the
	 * current character data. After ELEM_END this XElem instance is no longer
	 * valid and will be reused for further processing. If depth is zero return
	 * null.
	 */
