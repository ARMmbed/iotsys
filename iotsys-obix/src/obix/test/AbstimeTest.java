 ...
 */
public class AbstimeTest extends Test {

	public static TimeZone[] timeZones = { TimeZone.getDefault(), TimeZone.getTimeZone("GMT"),
			TimeZone.getTimeZone("America/New_York"), TimeZone.getTimeZone("America/Phoenix"),
			TimeZone.getTimeZone("America/Los_Angeles"), TimeZone.getTimeZone("US/Mountain"),
			TimeZone.getTimeZone("Europe/Brussels"), TimeZone.getTimeZone("Europe/Vienna"),
			TimeZone.getTimeZone("Asia/Tokyo"), TimeZone.getTimeZone("Asia/Hong_Kong"),
			new SimpleTimeZone(-4 * 60 * 60 * 1000, "Offset1"), new SimpleTimeZone(-5 * 60 * 60 * 1000, "Offset2") };
	...
	public void verifyCodec() throws Exception {
		 ...
		 * 
		 * Abstime t1 = new Abstime(2001, june, 7, 0, 0, 0, 0, est); Abstime t2
		 * = new Abstime(); t2.decodeVal(t1.encodeVal());
		 * 
		 ...
		 * 
		 * System.out.println("1: " + t1.encodeVal()); System.out.println("2: "
		 * + t2.encodeVal());
		 * 
		 * System.out.println("1: " + t1.getTimeZoneOffset() + " - " +
		 * t1.getTimeZone().getID()); System.out.println("2: " +
		 * t2.getTimeZoneOffset() + " - " + t2.getTimeZone().getID());
		 * verify(t1.equals(t2));
		 */
		...
		for (int i = 0; i < timeZones.length; ++i) {
			for (int j = 0; j < timeZones.length; ++j) {
				...
				Abstime[] times = { new Abstime(System.currentTimeMillis()),
						new Abstime(System.currentTimeMillis(), iz), new Abstime(System.currentTimeMillis(), jz),
						new Abstime(2001, june, 7, 0, 0, 0, 0, iz), new Abstime(2001, june, 7, 0, 0, 0, 0, jz),
						new Abstime(2001, november, 30, 0, 0, 0, 0, iz),
						new Abstime(2001, november, 30, 0, 0, 0, 0, jz), new Abstime(1004553579152L, iz),
		...
		/*
		 * Abstime t1 = new Abstime(2001, june, 1, 0, 0); Abstime t2 = new
		 * Abstime(2001, october, 31, 0, 0); Abstime t3 = new Abstime(2001,
		 * june, 1, 0, 0, 0, 0, TimeZone.getTimeZone("GMT")); Abstime t4 = new
		 * Abstime(2001, october, 31, 0, 0, 0, 0, TimeZone.getTimeZone("GMT"));
		 * 
		 * Abstime d1 =
		 * (Abstime)Abstime.DEFAULT.decodeFromString(t1.encodeToString());
		 * Abstime d2 =
		 * (Abstime)Abstime.DEFAULT.decodeFromString(t2.encodeToString());
		 * Abstime d3 =
		 * (Abstime)Abstime.DEFAULT.decodeFromString(t3.encodeToString());
		 * Abstime d4 =
		 * (Abstime)Abstime.DEFAULT.decodeFromString(t4.encodeToString());
		 * 
	...
	public void verifyNextPrevMonth() {
		// non-boundary
		verify(new Abstime(2003, july, 17).nextMonth().equals(new Abstime(2003, august, 17)));
		verify(new Abstime(2003, july, 17).prevMonth().equals(new Abstime(2003, june, 17)));
		// jan/dec
		verify(new Abstime(2003, december, 17).nextMonth().equals(new Abstime(2004, january, 17)));
		verify(new Abstime(2003, january, 17).prevMonth().equals(new Abstime(2002, december, 17)));
		// month caps next
		verify(new Abstime(2003, january, 31).nextMonth().equals(new Abstime(2003, february, 28)));
		verify(new Abstime(2003, january, 30).nextMonth().equals(new Abstime(2003, february, 28)));
		verify(new Abstime(2003, january, 29).nextMonth().equals(new Abstime(2003, february, 28)));
		verify(new Abstime(2003, january, 28).nextMonth().equals(new Abstime(2003, february, 28)));
		verify(new Abstime(2003, january, 27).nextMonth().equals(new Abstime(2003, february, 27)));
		// month caps prev (in leap year)
		verify(new Abstime(2004, march, 31).prevMonth().equals(new Abstime(2004, february, 29)));
		verify(new Abstime(2004, march, 30).prevMonth().equals(new Abstime(2004, february, 29)));
		verify(new Abstime(2004, march, 29).prevMonth().equals(new Abstime(2004, february, 29)));
		verify(new Abstime(2004, march, 28).prevMonth().equals(new Abstime(2004, february, 28)));
		// cap carry thru next
		verify(new Abstime(2003, february, 28).nextMonth().equals(new Abstime(2003, march, 31)));
		verify(new Abstime(2004, february, 29).nextMonth().equals(new Abstime(2004, march, 31)));
		verify(new Abstime(2004, march, 31).nextMonth().equals(new Abstime(2004, april, 30)));
		// cap carry thru prev
		verify(new Abstime(2004, april, 30).prevMonth().equals(new Abstime(2004, march, 31)));
		verify(new Abstime(2004, march, 31).prevMonth().equals(new Abstime(2004, february, 29)));
		verify(new Abstime(2004, february, 28).prevMonth().equals(new Abstime(2004, january, 28)));
		verify(new Abstime(2004, february, 29).prevMonth().equals(new Abstime(2004, january, 31)));
		verify(new Abstime(2003, march, 31).prevMonth().equals(new Abstime(2003, february, 28)));
		verify(new Abstime(2003, february, 28).prevMonth().equals(new Abstime(2003, january, 31)));
	}
	...
	public void verifyNextPrevYear() {
		// next
		verify(new Abstime(2003, april, 30).nextYear().equals(new Abstime(2004, april, 30)));
		verify(new Abstime(2003, february, 28).nextYear().equals(new Abstime(2004, february, 28)));
		verify(new Abstime(2004, february, 29).nextYear().equals(new Abstime(2005, february, 28)));

		// prev
		verify(new Abstime(2003, april, 30).prevYear().equals(new Abstime(2002, april, 30)));
		verify(new Abstime(2003, february, 28).prevYear().equals(new Abstime(2002, february, 28)));
		verify(new Abstime(2004, february, 29).prevYear().equals(new Abstime(2003, february, 28)));
	}
	...
	public void verifyNextPrevWeekdays() {
		verify(new Abstime(2003, july, 17).nextWeekday(thursday).equals(new Abstime(2003, july, 24)));
		verify(new Abstime(2003, july, 17).nextWeekday(friday).equals(new Abstime(2003, july, 18)));
		verify(new Abstime(2003, july, 17).nextWeekday(wednesday).equals(new Abstime(2003, july, 23)));
		verify(new Abstime(2003, december, 30).nextWeekday(friday).equals(new Abstime(2004, january, 2)));

		verify(new Abstime(2003, november, 3).prevWeekday(thursday).equals(new Abstime(2003, october, 30)));
		verify(new Abstime(2003, november, 3).prevWeekday(monday).equals(new Abstime(2003, october, 27)));
	}
