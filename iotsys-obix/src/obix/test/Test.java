...
/**
 * Test is base class for all Test classes as well as main entry point for
 * running obix unit tests.
 *
 * @author Brian Frank
 * @creation 27 Apr 05
...
public abstract class Test {
	...
	public static final Test[] tests = { new TreeTest(), new IOTest(), new AbstimeTest(), new ReltimeTest(),
			new TimeTest(), new DateTest(), new UriTest(), new ContractTest(), new FragmentsTest(), };
	...
	public Obj roundtrip(Obj orig, boolean testBinary) throws Exception {
