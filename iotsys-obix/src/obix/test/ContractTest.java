 ...
 */
public class ContractTest extends Test {
	...
	public void run() throws Exception {
		...
		unit = (Unit) make("<obj is='obix:Unit'>" + "<str name='symbol' val='\u00baC'/>"
				+ "<obj name='dimension'><int name='K' val='1'/></obj>" + "<real name='offset' val='273'/>" + "</obj>");
		...
		alarm = (AckAlarm) make(
				"<obj is='obix:AckAlarm'>" + "<abstime name='ackTimestamp' val='2005-09-21T13:14:02.12Z'/>"
