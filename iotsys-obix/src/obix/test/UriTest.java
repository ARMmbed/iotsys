 ...
 */
public class UriTest extends Test {
	...
	public void run() throws Exception {
		...
		verifyAbs("http://foo/x#f?q", "http", "foo", -1, "/x", null, "f?q"); // weird,
																				// but
																				// I
																				// believe
																				// correct
	...
	public void verifyAbs(String uriStr, String scheme, String host, int port, String path, String query, String frag)
		...
		/*
		 * System.out.println("test: " + uri); System.out.println("  scheme: " +
		 * uri.getScheme()); System.out.println("  host:   " + uri.getHost());
