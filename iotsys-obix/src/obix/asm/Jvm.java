 ...
 */
public final class Jvm implements OpCodes {
	...
	/**
	 * Return a field type descriptor based on a class type. FieldType: BaseType
	 * ObjectType ArrayType BaseType: B byte C char D double F float I int J
	...
	/**
	 * Return a descriptor string used to describe the signature of a method.
	 * This descriptor takes the format: MethodDescriptor ( ParameterDescritor*
	 * ) ReturnDescriptor ParameterDescriptor FieldType (excluding void)
	 * ReturnDescriptor FieldType (including void)
	 *
	 * Example: Object myMethod(int i, double d, Thread t) evaluates to
	 * (IDLjava/lang/Thread;)Ljava/lang/Object;
	 *
	 * @param paramTypes
	 *            array of parameter types, you may pass null instead of an
	 *            array of length 0, if there are no parameters to the method
	 * @param returnType
	...
	static final byte[] OPCODE_ARGS = { NONE, // NOP = 0x00
