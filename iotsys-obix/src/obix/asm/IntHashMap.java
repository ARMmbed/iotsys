...
/**
 * IntHashMap is an optimized hashtable for hashing objects by an integer keys.
 * It removes the need to use wrapper Integers as with the standard collection
 * classes.
 *
 * @author Brian Frank
 * @creation 2 Oct 97
...
public class IntHashMap {
	...
	/**
	 * Rehash contents of this table into a table with a larger capacity.
	 */
	private void rehash() {
	 ...
	 * 
	 * @return the previous value at this key, or null if it did not have one.
	 */
	 ...
	 *
	 * @return the old object at the key, or null if there was no previous
	 *         object for the key.
	 */
	...
	/**
	 * Return if the specified object another IntHashMap with the exact same
	 * key-value pairs.
	 */
