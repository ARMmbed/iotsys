...
public class TestRegisterService {
	...
	public static void main(String[] args) {
		...
		try {
			...
			ServiceInfo subTypedService = ServiceInfo.create("_obix._coap.local.", "aFanSpeed", "_sunblindactuator",
					8080, null);
			ServiceInfo subTypedService2 = ServiceInfo.create("_obix._coap.local.", "aFanSpeed2", "_fanspeedactuator",
					8081, null);
