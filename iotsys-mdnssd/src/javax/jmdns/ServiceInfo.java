...
public abstract class ServiceInfo implements Cloneable {
	 ...
	 * @return new service info
	 */
	public static ServiceInfo create(final String type, final String name, final int port, final int weight,
	...
	/**
	 * Set the IPv6 AAAA record for the service. Setting the AAAA will fore a
	 * re-announce of the service.
	 * 
	 * @param ipv6Addr
	 *            the string representation of the IPv6 address.
	 * @exception IllegalStateException
	 *                if attempting to set the address for a non persistent
	 *                service info.
	 * @throws SecurityException
	 * @throws UnknownHostException
	 */
	public abstract void setIpv6Addr(String ipv6Addr)
			throws IllegalStateException, UnknownHostException, SecurityException;

	/**
	 * Set the target server for the service, which is the devices' domain name.
	 * Setting this will fore a re-announce of the service.
	 * 
	 * @param serverName
