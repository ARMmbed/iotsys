	...
	public void writeObject(Obj input) {
		...
		if (input instanceof Bool) {
			...
			if (singleSelect.getHref().get().equals(resourceUriPath)) {
				...
				log.info("Writing on RFID Device: " + this.singleSelect().get());
				...
				log.info("Writing on RFID Device: " + this.multiSelect().get());
				...
				log.info("Writing on RFID Device: " + this.continousRead().get());
				...
				log.info("Writing on RFID Device: " + this.abortContinousRead().get());
