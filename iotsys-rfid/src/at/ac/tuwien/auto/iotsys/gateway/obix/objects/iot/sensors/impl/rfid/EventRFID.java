...
public interface EventRFID extends Sensor {
	...
	public static final String tagContract = "<Str name='" + RFID_TAG_NAME + "' href='" + RFID_TAG_HREF
			+ "' val='none'/> ";

	public static final String RFID_TIME_NAME = "time";
	public static final String RFID_TIME_HREF = "time";
	public static final String timeContract = "<Abstime name='" + RFID_TIME_NAME + "' href='" + RFID_TIME_HREF
			+ "' val='0'/>";
